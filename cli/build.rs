...
fn main() {
    ...
    prost_config.compile_well_known_types().type_attribute(".", "#[derive(::serde::Serialize, ::serde::Deserialize)]");
    ...
    copy("./src/proto/google.protobuf.rs", "./src/proto/google_protobuf.rs").unwrap();
    copy("./src/proto/trinsic.services.rs", "./src/proto/trinsic_services.rs").unwrap();
