...
$packageArgs = @{
  ...
  softwareName  = 'trinsic-cli*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
  ...
  checksum64    = '52C45D5151ED41FAA20025DE06A9BE8921FCB385EA488C7AFBD764BE80A05E2D'
...
## $osBitness ="64" # Get-ProcessorBits
