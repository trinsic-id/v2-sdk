...
class RequestedVerification {
  ...
  bool operator ==(Object other) =>
      ...
      other is RequestedVerification &&
          other.type == type &&
  ...
  @override
  String toString() =>
      'RequestedVerification[type=$type, governmentIdOptions=$governmentIdOptions]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "RequestedVerification[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "RequestedVerification[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<RequestedVerification> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<RequestedVerification>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = RequestedVerification.listFromJson(
          entry.value,
          growable: growable,
        );
      }
