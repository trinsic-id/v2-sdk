...
internal class CustomJsonCodec
{
    ...
    {
        if (obj != null && obj is Trinsic.Connect.Model.AbstractOpenAPISchema)
        {
            // the object to be serialized is an oneOf/anyOf schema
            return ((Trinsic.Connect.Model.AbstractOpenAPISchema)obj).ToJson();
        }
        else
        {
...
public partial class ApiClient : IDisposable, ISynchronousClient, IAsynchronousClient
{
    ...
    /// </summary>
    public ApiClient()
             : this(Trinsic.Connect.Client.GlobalConfiguration.Instance.BasePath)
    {
    }
    ...
    public ApiClient(HttpClient client, HttpClientHandler handler = null)
             : this(client, Trinsic.Connect.Client.GlobalConfiguration.Instance.BasePath, handler)
    {
    }
    ...
    private static HttpContent PrepareMultipartFormDataContent(RequestOptions options)
    {
        ...
        System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        ...
        try
        {
            ...
            if (typeof(Trinsic.Connect.Model.AbstractOpenAPISchema).IsAssignableFrom(typeof(T)))
            {
