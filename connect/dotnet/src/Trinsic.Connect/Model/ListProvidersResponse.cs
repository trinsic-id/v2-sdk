...
/// </summary>
[DataContract(Name = "ListProvidersResponse")]
public partial class ListProvidersResponse
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ListProvidersResponse" /> class.
    /// </summary>
    [JsonConstructorAttribute]
    protected ListProvidersResponse() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="ListProvidersResponse" /> class.
    /// </summary>
    /// <param name="integrations">The list of integrations available to your account (required).</param>
    public ListProvidersResponse(List<Integration> integrations = default(List<Integration>))
    {
        Integrations = integrations ?? throw new ArgumentNullException("integrations is a required property for ListProvidersResponse and cannot be null");
    }
