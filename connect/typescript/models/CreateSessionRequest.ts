...
export function CreateSessionRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateSessionRequest {
    ...
    return {
        ...
        'verifications': json['verifications'] == null ? undefined : ((json['verifications'] as Array<any>).map(RequestedVerificationFromJSON)),
    };
}
...
export function CreateSessionRequestToJSON(value?: CreateSessionRequest | null): any {
    ...
    return {
        ...
        'verifications': value['verifications'] == null ? undefined : ((value['verifications'] as Array<any>).map(RequestedVerificationToJSON)),
    };
}
