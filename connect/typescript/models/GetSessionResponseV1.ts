 ...
 */
export function instanceOfGetSessionResponseV1(value: object): value is GetSessionResponseV1 {
    return true;
}
...
export function GetSessionResponseV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): GetSessionResponseV1 {
    if (json == null) {
        return json;
    }
    return {
...
export function GetSessionResponseV1ToJSON(value?: GetSessionResponseV1 | null): any {
    if (value == null) {
        return value;
    }
    return {
