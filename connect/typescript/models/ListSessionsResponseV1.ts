 ...
 */
export function instanceOfListSessionsResponseV1(value: object): value is ListSessionsResponseV1 {
    return true;
}

export function ListSessionsResponseV1FromJSON(json: any): ListSessionsResponseV1 {
    return ListSessionsResponseV1FromJSONTyped(json, false);
}

export function ListSessionsResponseV1FromJSONTyped(json: any, ignoreDiscriminator: boolean): ListSessionsResponseV1 {
    if (json == null) {
        return json;
    }
    return {
...
export function ListSessionsResponseV1ToJSON(value?: ListSessionsResponseV1 | null): any {
    if (value == null) {
        return value;
    }
    return {
