 ...
 */
export function instanceOfRequestedVerification(value: object): value is RequestedVerification {
    return true;
}

export function RequestedVerificationFromJSON(json: any): RequestedVerification {
    return RequestedVerificationFromJSONTyped(json, false);
}

export function RequestedVerificationFromJSONTyped(json: any, ignoreDiscriminator: boolean): RequestedVerification {
    if (json == null) {
        return json;
    }
    return {
...
export function RequestedVerificationToJSON(value?: RequestedVerification | null): any {
    if (value == null) {
        return value;
    }
    return {
