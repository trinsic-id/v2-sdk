...
export function VerificationFailCodeFromJSONTyped(json: any, ignoreDiscriminator: boolean): VerificationFailCode {
    return json as VerificationFailCode;
}

export function VerificationFailCodeToJSON(value?: VerificationFailCode | null): any {
    return value as any;
}
