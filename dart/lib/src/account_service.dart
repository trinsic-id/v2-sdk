...
// target: ..\sdk\dart\lib\src\account_service.dart
    ...
    Future<AccountInfoResponse> info(AccountInfoRequest request) async {
        ...
        return await client.info(request, options: buildMetadata(request));
    }
    Future<ListDevicesResponse> listDevices(ListDevicesRequest request) async {
         ///  List all connected devices
        return await client.listDevices(request, options: buildMetadata(request));
    }
    Future<RevokeDeviceResponse> revokeDevice(RevokeDeviceRequest request) async {
        ...
        return await client.revokeDevice(request, options: buildMetadata(request));
    }
    Future<AuthorizeWebhookResponse> authorizeWebhook(AuthorizeWebhookRequest request) async {
        ...
        return await client.authorizeWebhook(request, options: buildMetadata(request));
    }
