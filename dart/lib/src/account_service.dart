...
// target: C:\work\sdk\dart\lib\src\account_service.dart
    ...
    Future<ListDevicesResponse> listDevices(ListDevicesRequest request) async {
        ...
        return client.listDevices(request, options: await buildMetadata(request: request));
    }
    Future<RevokeDeviceResponse> revokeDevice(RevokeDeviceRequest request) async {
        ...
        return client.revokeDevice(request, options: await buildMetadata(request: request));
    }
    Future<AuthorizeWebhookResponse> authorizeWebhook(AuthorizeWebhookRequest request) async {
        ...
        return client.authorizeWebhook(request, options: await buildMetadata(request: request));
    }
