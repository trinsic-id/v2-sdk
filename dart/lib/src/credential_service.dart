...
/// The document must be a valid JSON-LD document.
        return await client.issue(request, options: buildMetadata(request));
    }
...
/// revocation registry values to the credential.
        return await client.issueFromTemplate(request, options: buildMetadata(request));
    }
    Future<CheckStatusResponse> checkStatus(CheckStatusRequest request) async {
         ///  Check credential status in the revocation registry
        return await client.checkStatus(request, options: buildMetadata(request));
    }
    Future<UpdateStatusResponse> updateStatus(UpdateStatusRequest request) async {
         ///  Update credential status by setting the revocation value
        return await client.updateStatus(request, options: buildMetadata(request));
    }
...
/// verifiable credential and contains a signature from which a proof can be derived.
        return await client.createProof(request, options: buildMetadata(request));
    }
    Future<VerifyProofResponse> verifyProof(VerifyProofRequest request) async {
         ///  Verifies a proof by checking the signature value, and if possible schema validation,
/// revocation status, and issuer status against a trust registry
        return await client.verifyProof(request, options: buildMetadata(request));
    }
    Future<SendResponse> send(SendRequest request) async {
         ///  Sends a document directly to a user's email within the given ecosystem
        return await client.send(request, options: buildMetadata(request));
    }
