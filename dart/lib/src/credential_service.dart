...
// target: C:\work\sdk\dart\lib\src\credential_service.dart
  ...
  Future<CreateCredentialOfferResponse> createCredentialOffer(
      CreateCredentialOfferRequest request) async {
    ///  Create credential offer

    return client.createCredentialOffer(request,
        options: await buildMetadata(request: request));
  }

  Future<AcceptCredentialResponse> acceptCredential(
      AcceptCredentialRequest request) async {
    ///  Accept an offer to exchange a credential

    return client.acceptCredential(request,
        options: await buildMetadata(request: request));
  }

  Future<RejectCredentialResponse> rejectCredential(
      RejectCredentialRequest request) async {
    ///  Reject an offer to exchange a credential

    return client.rejectCredential(request,
        options: await buildMetadata(request: request));
  }
