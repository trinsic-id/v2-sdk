...
// target: C:\work\sdk\dart\lib\src\debug_service.dart
    ...
    Future<Empty> callEmpty(Empty request) async {
        ...
        return await client.callEmpty(request, options: buildMetadata(request: request));
    }
    Future<Empty> callEmptyAuth(Empty request) async {
        
        return await client.callEmptyAuth(request, options: buildMetadata(request: request));
    }
