...
class TrustRegistryClient extends $grpc.Client {
  ...
  static final _$fetchData =
      $grpc.ClientMethod<$3.FetchDataRequest, $3.FetchDataResponse>(
          '/services.trustregistry.v1.TrustRegistry/FetchData',
          ($3.FetchDataRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $3.FetchDataResponse.fromBuffer(value));
  ...
  $grpc.ResponseStream<$3.FetchDataResponse> fetchData(
      $3.FetchDataRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class TrustRegistryServiceBase extends $grpc.Service {
  ...
  TrustRegistryServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$3.FetchDataRequest, $3.FetchDataResponse>(
        'FetchData',
        fetchData_Pre,
        false,
        true,
        ($core.List<$core.int> value) => $3.FetchDataRequest.fromBuffer(value),
        ($3.FetchDataResponse value) => value.writeToBuffer()));
  }
  ...
  $async.Stream<$3.FetchDataResponse> fetchData_Pre($grpc.ServiceCall call,
      $async.Future<$3.FetchDataRequest> request) async* {
  ...
  $async.Stream<$3.FetchDataResponse> fetchData(
      $grpc.ServiceCall call, $3.FetchDataRequest request);
}
