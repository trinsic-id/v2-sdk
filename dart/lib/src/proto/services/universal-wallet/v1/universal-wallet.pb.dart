...
class CreateWalletResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$4.WalletConfiguration>(4, _omitFieldNames ? '' : 'wallet',
...
class GetWalletInfoResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'services.universalwallet.v1'),
      createEmptyInstance: create)
    ..aOM<$4.WalletConfiguration>(1, _omitFieldNames ? '' : 'wallet',
        subBuilder: $4.WalletConfiguration.create)
    ..hasRequiredFields = false;
...
class GetWalletFromExternalIdentityRequest extends $pb.GeneratedMessage {
  factory GetWalletFromExternalIdentityRequest({
    $4.WalletExternalIdentity? identity,
  }) {
    final $result = create();
    if (identity != null) {
      $result.identity = identity;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'services.universalwallet.v1'),
      createEmptyInstance: create)
    ..aOM<$4.WalletExternalIdentity>(1, _omitFieldNames ? '' : 'identity',
        subBuilder: $4.WalletExternalIdentity.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $4.WalletExternalIdentity get identity => $_getN(0);
  @$pb.TagNumber(1)
  set identity($4.WalletExternalIdentity v) {
    setField(1, v);
  }
  ...
  void clearIdentity() => clearField(1);
  @$pb.TagNumber(1)
  $4.WalletExternalIdentity ensureIdentity() => $_ensure(0);
}
