...
import '../../provider/v1/provider.pb.dart' as $0;
import '../../provider/v1/provider.pbenum.dart' as $0;
...
class CreateWalletRequest_ExternalIdentity extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<$0.IdentityProvider>(
        2, _omitFieldNames ? '' : 'provider', $pb.PbFieldType.OE,
        defaultOrMaker: $0.IdentityProvider.Unknown,
        valueOf: $0.IdentityProvider.valueOf,
        enumValues: $0.IdentityProvider.values)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  $0.IdentityProvider get provider => $_getN(1);
  @$pb.TagNumber(2)
  set provider($0.IdentityProvider v) {
    setField(2, v);
  }
...
class CreateWalletResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$0.WalletConfiguration>(4, _omitFieldNames ? '' : 'wallet',
        subBuilder: $0.WalletConfiguration.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(4)
  $0.WalletConfiguration get wallet => $_getN(2);
  @$pb.TagNumber(4)
  set wallet($0.WalletConfiguration v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(4)
  $0.WalletConfiguration ensureWallet() => $_ensure(2);
}
...
class GetWalletInfoResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'services.universalwallet.v1'),
      createEmptyInstance: create)
    ..aOM<$0.WalletConfiguration>(1, _omitFieldNames ? '' : 'wallet',
        subBuilder: $0.WalletConfiguration.create)
    ..hasRequiredFields = false;
  ...
  /// Wallet configuration
  @$pb.TagNumber(1)
  $0.WalletConfiguration get wallet => $_getN(0);
  @$pb.TagNumber(1)
  set wallet($0.WalletConfiguration v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $0.WalletConfiguration ensureWallet() => $_ensure(0);
}
...
class ListWalletsResponse extends $pb.GeneratedMessage {
  factory ListWalletsResponse({
    $core.Iterable<$0.WalletConfiguration>? wallets,
  }) {
    final $result = create();
    if (wallets != null) {
...
class GetWalletFromExternalIdentityRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'services.universalwallet.v1'),
      createEmptyInstance: create)
    ..aOM<$0.WalletExternalIdentity>(1, _omitFieldNames ? '' : 'identity',
        subBuilder: $0.WalletExternalIdentity.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $0.WalletExternalIdentity get identity => $_getN(0);
  @$pb.TagNumber(1)
  set identity($0.WalletExternalIdentity v) {
    setField(1, v);
  }
  ...
  void clearIdentity() => clearField(1);
  @$pb.TagNumber(1)
  $0.WalletExternalIdentity ensureIdentity() => $_ensure(0);
}
