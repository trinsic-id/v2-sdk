...
class UniversalWalletClient extends $grpc.Client {
  ...
  static final _$getWalletFromExternalIdentity = $grpc.ClientMethod<
          $4.GetWalletFromExternalIdentityRequest,
          $4.GetWalletFromExternalIdentityResponse>(
      '/services.universalwallet.v1.UniversalWallet/GetWalletFromExternalIdentity',
      ($4.GetWalletFromExternalIdentityRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $4.GetWalletFromExternalIdentityResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$4.GetWalletFromExternalIdentityResponse>
      getWalletFromExternalIdentity(
          $4.GetWalletFromExternalIdentityRequest request,
          {$grpc.CallOptions? options}) {
...
abstract class UniversalWalletServiceBase extends $grpc.Service {
  ...
  UniversalWalletServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$4.GetWalletFromExternalIdentityRequest,
            $4.GetWalletFromExternalIdentityResponse>(
        'GetWalletFromExternalIdentity',
        ...
        false,
        ($core.List<$core.int> value) =>
            $4.GetWalletFromExternalIdentityRequest.fromBuffer(value),
        ($4.GetWalletFromExternalIdentityResponse value) =>
            value.writeToBuffer()));
  ...
  $async.Future<$4.GetWalletFromExternalIdentityResponse>
      getWalletFromExternalIdentity_Pre(
          $grpc.ServiceCall call,
          $async.Future<$4.GetWalletFromExternalIdentityRequest>
              request) async {
