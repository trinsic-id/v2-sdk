...
class UniversalWalletClient extends $grpc.Client {
  ...
  static final _$listByVerificationTemplate = $grpc.ClientMethod<
          $6.ListByVerificationTemplateRequest,
          $6.ListByVerificationTemplateResponse>(
      '/services.universalwallet.v1.UniversalWallet/ListByVerificationTemplate',
      ($6.ListByVerificationTemplateRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $6.ListByVerificationTemplateResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$6.ListByVerificationTemplateResponse>
      listByVerificationTemplate($6.ListByVerificationTemplateRequest request,
          {$grpc.CallOptions? options}) {
...
abstract class UniversalWalletServiceBase extends $grpc.Service {
  ...
  UniversalWalletServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$6.ListByVerificationTemplateRequest,
            $6.ListByVerificationTemplateResponse>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $6.ListByVerificationTemplateRequest.fromBuffer(value),
        ($6.ListByVerificationTemplateResponse value) =>
            value.writeToBuffer()));
  }
  ...
  $async.Future<$6.ListByVerificationTemplateResponse>
      listByVerificationTemplate_Pre($grpc.ServiceCall call,
          $async.Future<$6.ListByVerificationTemplateRequest> request) async {
  ...
  $async.Future<$6.ListByVerificationTemplateResponse>
      listByVerificationTemplate(
          $grpc.ServiceCall call, $6.ListByVerificationTemplateRequest request);
}
