...
@$core.Deprecated('Use listByVerificationTemplateRequestDescriptor instead')
const ListByVerificationTemplateRequest$json = {
...
/// Descriptor for `ListByVerificationTemplateRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listByVerificationTemplateRequestDescriptor =
    $convert.base64Decode(
        'CiFMaXN0QnlWZXJpZmljYXRpb25UZW1wbGF0ZVJlcXVlc3QSOAoYdmVyaWZpY2F0aW9uX3RlbX'
        'BsYXRlX2lkGAEgASgJUhZ2ZXJpZmljYXRpb25UZW1wbGF0ZUlkEjMKEmNvbnRpbnVhdGlvbl90'
        'b2tlbhgCIAEoCUIEgKYdAVIRY29udGludWF0aW9uVG9rZW4=');
...
/// Descriptor for `ListByVerificationTemplateResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listByVerificationTemplateResponseDescriptor =
    $convert.base64Decode(
        'CiJMaXN0QnlWZXJpZmljYXRpb25UZW1wbGF0ZVJlc3BvbnNlEhQKBWl0ZW1zGAEgAygJUgVpdG'
        'VtcxIoChBoYXNfbW9yZV9yZXN1bHRzGAIgASgIUg5oYXNNb3JlUmVzdWx0cxItChJjb250aW51'
        'YXRpb25fdG9rZW4YAyABKAlSEWNvbnRpbnVhdGlvblRva2Vu');
