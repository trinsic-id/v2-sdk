...
final $typed_data.Uint8List createVerificationTemplateRequestDescriptor = $convert.base64Decode(
    ...
    'JeCgZmaWVsZHMYAiADKAsyRi5zZXJ2aWNlcy52ZXJpZmlhYmxlY3JlZGVudGlhbHMudGVtcGxh'
    'dGVzLnYxLlZlcmlmaWNhdGlvblRlbXBsYXRlRmllbGRSBmZpZWxkcxI0ChZjcmVkZW50aWFsX3'
    'RlbXBsYXRlX2lkGAMgASgJUhRjcmVkZW50aWFsVGVtcGxhdGVJZBIUCgV0aXRsZRgEIAEoCVIF'
    'dGl0bGUSIAoLZGVzY3JpcHRpb24YBSABKAlSC2Rlc2NyaXB0aW9u');
...
const VerificationTemplateField$json = {
  ...
  '2': [
    ...
    {'1': 'usage_policy', '3': 3, '4': 1, '5': 9, '10': 'usagePolicy'},
  ],
};
...
final $typed_data.Uint8List verificationTemplateFieldDescriptor = $convert.base64Decode(
    'ChlWZXJpZmljYXRpb25UZW1wbGF0ZUZpZWxkEhIKBG5hbWUYASABKAlSBG5hbWUSbAoQZmllbG'
    'Rfc2hhcmVfdHlwZRgCIAEoDjJCLnNlcnZpY2VzLnZlcmlmaWFibGVjcmVkZW50aWFscy50ZW1w'
    'bGF0ZXMudjEuVmVyaWZpY2F0aW9uU2hhcmVUeXBlUg5maWVsZFNoYXJlVHlwZRIhCgx1c2FnZV'
    '9wb2xpY3kYAyABKAlSC3VzYWdlUG9saWN5');
