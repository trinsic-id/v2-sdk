...
class VerifiableCredentialClient extends $grpc.Client {
  ...
  static final _$createCredentialOffer = $grpc.ClientMethod<
          $5.CreateCredentialOfferRequest, $5.CreateCredentialOfferResponse>(
      '/services.verifiablecredentials.v1.VerifiableCredential/CreateCredentialOffer',
      ($5.CreateCredentialOfferRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $5.CreateCredentialOfferResponse.fromBuffer(value));
  static final _$acceptCredential = $grpc.ClientMethod<
          $5.AcceptCredentialRequest, $5.AcceptCredentialResponse>(
      '/services.verifiablecredentials.v1.VerifiableCredential/AcceptCredential',
      ($5.AcceptCredentialRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $5.AcceptCredentialResponse.fromBuffer(value));
  static final _$rejectCredential = $grpc.ClientMethod<
          $5.RejectCredentialRequest, $5.RejectCredentialResponse>(
      '/services.verifiablecredentials.v1.VerifiableCredential/RejectCredential',
      ($5.RejectCredentialRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $5.RejectCredentialResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$5.CreateCredentialOfferResponse> createCredentialOffer(
      $5.CreateCredentialOfferRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$createCredentialOffer, request, options: options);
  }

  $grpc.ResponseFuture<$5.AcceptCredentialResponse> acceptCredential(
      $5.AcceptCredentialRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$acceptCredential, request, options: options);
  }

  $grpc.ResponseFuture<$5.RejectCredentialResponse> rejectCredential(
      $5.RejectCredentialRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class VerifiableCredentialServiceBase extends $grpc.Service {
  ...
  VerifiableCredentialServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$5.CreateCredentialOfferRequest,
            $5.CreateCredentialOfferResponse>(
        'CreateCredentialOffer',
        createCredentialOffer_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $5.CreateCredentialOfferRequest.fromBuffer(value),
        ($5.CreateCredentialOfferResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$5.AcceptCredentialRequest,
            $5.AcceptCredentialResponse>(
        'AcceptCredential',
        acceptCredential_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $5.AcceptCredentialRequest.fromBuffer(value),
        ($5.AcceptCredentialResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$5.RejectCredentialRequest,
            $5.RejectCredentialResponse>(
        'RejectCredential',
        rejectCredential_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $5.RejectCredentialRequest.fromBuffer(value),
        ($5.RejectCredentialResponse value) => value.writeToBuffer()));
  }
  ...
  $async.Future<$5.CreateCredentialOfferResponse> createCredentialOffer_Pre(
      $grpc.ServiceCall call,
      $async.Future<$5.CreateCredentialOfferRequest> request) async {
    return createCredentialOffer(call, await request);
  }

  $async.Future<$5.AcceptCredentialResponse> acceptCredential_Pre(
      $grpc.ServiceCall call,
      $async.Future<$5.AcceptCredentialRequest> request) async {
    return acceptCredential(call, await request);
  }

  $async.Future<$5.RejectCredentialResponse> rejectCredential_Pre(
      $grpc.ServiceCall call,
      $async.Future<$5.RejectCredentialRequest> request) async {
  ...
  $async.Future<$5.CreateCredentialOfferResponse> createCredentialOffer(
      $grpc.ServiceCall call, $5.CreateCredentialOfferRequest request);
  $async.Future<$5.AcceptCredentialResponse> acceptCredential(
      $grpc.ServiceCall call, $5.AcceptCredentialRequest request);
  $async.Future<$5.RejectCredentialResponse> rejectCredential(
      $grpc.ServiceCall call, $5.RejectCredentialRequest request);
}
