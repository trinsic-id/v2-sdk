...
final $typed_data.Uint8List issueRequestDescriptor = $convert.base64Decode('CgxJc3N1ZVJlcXVlc3QSIwoNZG9jdW1lbnRfanNvbhgBIAEoCVIMZG9jdW1lbnRKc29u');
@$core.Deprecated('Use issueResponseDescriptor instead')
const IssueResponse$json = const {
  '1': 'IssueResponse',
  '2': const [
    const {'1': 'signed_document_json', '3': 1, '4': 1, '5': 9, '10': 'signedDocumentJson'},
  ],
};

/// Descriptor for `IssueResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List issueResponseDescriptor = $convert.base64Decode('Cg1Jc3N1ZVJlc3BvbnNlEjAKFHNpZ25lZF9kb2N1bWVudF9qc29uGAEgASgJUhJzaWduZWREb2N1bWVudEpzb24=');
...
const IssueFromTemplateRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'framework_id', '3': 3, '4': 1, '5': 9, '8': const {}, '10': 'frameworkId'},
  ],
};

/// Descriptor for `IssueFromTemplateRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List issueFromTemplateRequestDescriptor = $convert.base64Decode('ChhJc3N1ZUZyb21UZW1wbGF0ZVJlcXVlc3QSHwoLdGVtcGxhdGVfaWQYASABKAlSCnRlbXBsYXRlSWQSHwoLdmFsdWVzX2pzb24YAiABKAlSCnZhbHVlc0pzb24SJwoMZnJhbWV3b3JrX2lkGAMgASgJQgSAph0BUgtmcmFtZXdvcmtJZA==');
...
final $typed_data.Uint8List issueFromTemplateResponseDescriptor = $convert.base64Decode('ChlJc3N1ZUZyb21UZW1wbGF0ZVJlc3BvbnNlEiMKDWRvY3VtZW50X2pzb24YASABKAlSDGRvY3VtZW50SnNvbg==');
@$core.Deprecated('Use createProofRequestDescriptor instead')
const CreateProofRequest$json = const {
  '1': 'CreateProofRequest',
  '2': const [
    const {'1': 'reveal_document_json', '3': 1, '4': 1, '5': 9, '10': 'revealDocumentJson'},
    const {'1': 'item_id', '3': 2, '4': 1, '5': 9, '9': 0, '10': 'itemId'},
    const {'1': 'document_json', '3': 3, '4': 1, '5': 9, '9': 0, '10': 'documentJson'},
  ],
  '8': const [
    const {'1': 'proof'},
  ],
...
final $typed_data.Uint8List createProofRequestDescriptor = $convert.base64Decode('ChJDcmVhdGVQcm9vZlJlcXVlc3QSMAoUcmV2ZWFsX2RvY3VtZW50X2pzb24YASABKAlSEnJldmVhbERvY3VtZW50SnNvbhIZCgdpdGVtX2lkGAIgASgJSABSBml0ZW1JZBIlCg1kb2N1bWVudF9qc29uGAMgASgJSABSDGRvY3VtZW50SnNvbkIHCgVwcm9vZg==');
@$core.Deprecated('Use createProofResponseDescriptor instead')
const CreateProofResponse$json = const {
  '1': 'CreateProofResponse',
  '2': const [
    const {'1': 'proof_document_json', '3': 1, '4': 1, '5': 9, '10': 'proofDocumentJson'},
  ],
};

/// Descriptor for `CreateProofResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createProofResponseDescriptor = $convert.base64Decode('ChNDcmVhdGVQcm9vZlJlc3BvbnNlEi4KE3Byb29mX2RvY3VtZW50X2pzb24YASABKAlSEXByb29mRG9jdW1lbnRKc29u');
...
final $typed_data.Uint8List verifyProofRequestDescriptor = $convert.base64Decode('ChJWZXJpZnlQcm9vZlJlcXVlc3QSLgoTcHJvb2ZfZG9jdW1lbnRfanNvbhgBIAEoCVIRcHJvb2ZEb2N1bWVudEpzb24=');
...
const VerifyProofResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'validation_results', '3': 3, '4': 3, '5': 11, '6': '.services.verifiablecredentials.v1.VerifyProofResponse.ValidationResultsEntry', '10': 'validationResults'},
  ],
...
const VerifyProofResponse_ValidationResultsEntry$json = const {
  ...
  '2': const [
    ...
    const {'1': 'value', '3': 2, '4': 1, '5': 11, '6': '.services.verifiablecredentials.v1.ValidationMessage', '10': 'value'},
  ],
  '7': const {'7': true},
};

/// Descriptor for `VerifyProofResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List verifyProofResponseDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List validationMessageDescriptor = $convert.base64Decode('ChFWYWxpZGF0aW9uTWVzc2FnZRIZCghpc192YWxpZBgBIAEoCFIHaXNWYWxpZBIaCghtZXNzYWdlcxgCIAMoCVIIbWVzc2FnZXM=');
...
const SendRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'didcomm_invitation_json', '3': 3, '4': 1, '5': 9, '9': 0, '10': 'didcommInvitationJson'},
    const {'1': 'document_json', '3': 100, '4': 1, '5': 9, '10': 'documentJson'},
  ],
  '8': const [
...
final $typed_data.Uint8List sendRequestDescriptor = $convert.base64Decode('CgtTZW5kUmVxdWVzdBIWCgVlbWFpbBgBIAEoCUgAUgVlbWFpbBIZCgdkaWRfdXJpGAIgASgJSABSBmRpZFVyaRI4ChdkaWRjb21tX2ludml0YXRpb25fanNvbhgDIAEoCUgAUhVkaWRjb21tSW52aXRhdGlvbkpzb24SIwoNZG9jdW1lbnRfanNvbhhkIAEoCVIMZG9jdW1lbnRKc29uQhEKD2RlbGl2ZXJ5X21ldGhvZA==');
...
const UpdateStatusRequest$json = const {
  ...
  '2': const [
    const {'1': 'credential_status_id', '3': 1, '4': 1, '5': 9, '10': 'credentialStatusId'},
    const {'1': 'revoked', '3': 2, '4': 1, '5': 8, '10': 'revoked'},
  ],
};

/// Descriptor for `UpdateStatusRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateStatusRequestDescriptor = $convert.base64Decode('ChNVcGRhdGVTdGF0dXNSZXF1ZXN0EjAKFGNyZWRlbnRpYWxfc3RhdHVzX2lkGAEgASgJUhJjcmVkZW50aWFsU3RhdHVzSWQSGAoHcmV2b2tlZBgCIAEoCFIHcmV2b2tlZA==');
...
final $typed_data.Uint8List checkStatusRequestDescriptor = $convert.base64Decode('ChJDaGVja1N0YXR1c1JlcXVlc3QSMAoUY3JlZGVudGlhbF9zdGF0dXNfaWQYASABKAlSEmNyZWRlbnRpYWxTdGF0dXNJZA==');
