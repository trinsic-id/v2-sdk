...
class ProviderService extends ServiceBase {
  ...
  Future<CreateEcosystemResponse> createEcosystem(
    ...
    var response =
        await client.createEcosystem(request, options: buildMetadata(request));
...
// target: ..\sdk\dart\lib\src\provider_service.dart
    ...
    Future<UpdateEcosystemResponse> updateEcosystem(UpdateEcosystemRequest request) async {
        ...
        return await client.updateEcosystem(request, options: buildMetadata(request));
    }
    Future<GrantAuthorizationResponse> grantAuthorization(GrantAuthorizationRequest request) async {
        ...
        return await client.grantAuthorization(request, options: buildMetadata(request));
    }
    Future<RevokeAuthorizationResponse> revokeAuthorization(RevokeAuthorizationRequest request) async {
        ...
        return await client.revokeAuthorization(request, options: buildMetadata(request));
    }
