...
// target: C:\work\sdk\dart\lib\src\provider_service.dart
    ...
    Future<UpdateEcosystemResponse> updateEcosystem(UpdateEcosystemRequest request) async {
        ...
        return await client.updateEcosystem(request, options: buildMetadata(request: request));
    }
    Future<GrantAuthorizationResponse> grantAuthorization(GrantAuthorizationRequest request) async {
        ...
        return await client.grantAuthorization(request, options: buildMetadata(request: request));
    }
    Future<RevokeAuthorizationResponse> revokeAuthorization(RevokeAuthorizationRequest request) async {
        ...
        return await client.revokeAuthorization(request, options: buildMetadata(request: request));
    }
    Future<GetAuthorizationsResponse> getAuthorizations(GetAuthorizationsRequest request) async {
        ...
        return await client.getAuthorizations(request, options: buildMetadata(request: request));
    }
    Future<AddWebhookResponse> addWebhook(AddWebhookRequest request) async {
         ///  Add a webhook endpoint to the ecosystem
        return await client.addWebhook(request, options: buildMetadata(request: request));
    }
    Future<DeleteWebhookResponse> deleteWebhook(DeleteWebhookRequest request) async {
         ///  Delete a webhook endpoint from the ecosystem
        return await client.deleteWebhook(request, options: buildMetadata(request: request));
    }
    Future<EcosystemInfoResponse> ecosystemInfo(EcosystemInfoRequest request) async {
         ///  Get ecosystem information
        return await client.ecosystemInfo(request, options: buildMetadata(request: request));
    }
    Future<GenerateTokenResponse> generateToken(GenerateTokenRequest request) async {
         ///  Generates an unprotected authentication token that can be used to
/// configure server side applications
        return await client.generateToken(request, options: buildMetadata(request: request));
    }
    Future<InviteResponse> invite(InviteRequest request) async {
         ///  Invite a user to the ecosystem
        return await client.invite(request, options: buildMetadata(request: request));
    }
    Future<InvitationStatusResponse> invitationStatus(InvitationStatusRequest request) async {
         ///  Check the status of an invitation
        return await client.invitationStatus(request, options: buildMetadata(request: request));
    }
    ...
    Future<GetEventTokenResponse> getEventToken(GetEventTokenRequest request) async {
        ...
        return await client.getEventToken(request, options: buildMetadata(request: request));
    }
    Future<RetrieveVerificationRecordResponse> retrieveVerificationRecord(RetrieveVerificationRecordRequest request) async {
         ///  Retrieve a random hash TXT that can be used to verify domain ownership
        return await client.retrieveVerificationRecord(request, options: buildMetadata(request: request));
    }
    Future<RefreshVerificationStatusResponse> refreshVerificationStatus(RefreshVerificationStatusRequest request) async {
         ///  Call to verif
        return await client.refreshVerificationStatus(request, options: buildMetadata(request: request));
    }
