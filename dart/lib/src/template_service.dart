...
// target: /home/runner/work/sdk/sdk/dart/lib/src/template_service.dart
  ...
  Future<CreateCredentialTemplateResponse> create(
    ...
    return client.create(request, options: buildMetadata(request: request));
  }
  ...
  Future<GetCredentialTemplateResponse> get(
    ...
    return client.get(request, options: buildMetadata(request: request));
  }
  ...
  Future<ListCredentialTemplatesResponse> list(
    ...
    return client.list(request, options: buildMetadata(request: request));
  }
  ...
  Future<DeleteCredentialTemplateResponse> delete(
    ...
    return client.delete(request, options: buildMetadata(request: request));
  }
