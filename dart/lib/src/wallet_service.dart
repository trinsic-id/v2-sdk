...
// target: C:\work\sdk\dart\lib\src\wallet_service.dart
    ...
    Future<GetItemResponse> getItem(GetItemRequest request) async {
        ...
        return client.getItem(request, options: await buildMetadata(request: request));
    }
    ...
    Future<InsertItemResponse> insertItem(InsertItemRequest request) async {
        ...
        return client.insertItem(request, options: await buildMetadata(request: request));
    }
    
    Future<UpdateItemResponse> updateItem(UpdateItemRequest request) async {
         ///  Update an item in the wallet
        
        return client.updateItem(request, options: await buildMetadata(request: request));
    }
    
    Future<DeleteItemResponse> deleteItem(DeleteItemRequest request) async {
         ///  Delete an item from the wallet permanently
        
        return client.deleteItem(request, options: await buildMetadata(request: request));
    }
    
    Future<DeleteWalletResponse> deleteWallet(DeleteWalletRequest request) async {
         ///  Delete a wallet and its credentials
        
        return client.deleteWallet(request, options: await buildMetadata(request: request));
    }
