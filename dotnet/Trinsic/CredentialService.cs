...
// target: /home/runner/work/sdk/sdk/dotnet/Trinsic/CredentialService.cs
    ...
    public CreateCredentialOfferResponse CreateCredentialOffer(CreateCredentialOfferRequest request) {
        
        return Client.CreateCredentialOffer(request, BuildMetadata(request));
    }
    ...
    public async Task<CreateCredentialOfferResponse> CreateCredentialOfferAsync(CreateCredentialOfferRequest request) {
        
        return await Client.CreateCredentialOfferAsync(request, await BuildMetadataAsync(request));
    }
    ...
    public AcceptCredentialResponse AcceptCredential(AcceptCredentialRequest request) {
        
        return Client.AcceptCredential(request, BuildMetadata(request));
    }
    ...
    public async Task<AcceptCredentialResponse> AcceptCredentialAsync(AcceptCredentialRequest request) {
        
        return await Client.AcceptCredentialAsync(request, await BuildMetadataAsync(request));
    }
    ...
    public RejectCredentialResponse RejectCredential(RejectCredentialRequest request) {
        
        return Client.RejectCredential(request, BuildMetadata(request));
    }
    ...
    public async Task<RejectCredentialResponse> RejectCredentialAsync(RejectCredentialRequest request) {
        
        return await Client.RejectCredentialAsync(request, await BuildMetadataAsync(request));
    }
