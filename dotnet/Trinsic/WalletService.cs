...
// target: /home/runner/work/sdk/sdk/dotnet/Trinsic/WalletService.cs
    ...
    public CreateDidWebDocResponse CreateDidWebDoc(CreateDidWebDocRequest request) {
        
        return Client.CreateDidWebDoc(request, BuildMetadata(request));
    }
    ...
    public async Task<CreateDidWebDocResponse> CreateDidWebDocAsync(CreateDidWebDocRequest request) {
        
        return await Client.CreateDidWebDocAsync(request, await BuildMetadataAsync(request));
    }
