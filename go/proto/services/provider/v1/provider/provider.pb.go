...
var file_services_provider_v1_provider_proto_rawDesc = []byte{
	...
	0x64, 0x69, 0x64, 0x32, 0xdb, 0x07, 0x0a, 0x08, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72,
	...
	0x22, 0x06, 0x8a, 0xa6, 0x1d, 0x02, 0x10, 0x01, 0x12, 0x9e, 0x01, 0x0a, 0x0f, 0x55, 0x70, 0x64,
	...
	0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x2e, 0x8a, 0xa6, 0x1d, 0x27, 0x2a,
	0x25, 0x08, 0x01, 0x12, 0x21, 0x54, 0x68, 0x69, 0x73, 0x20, 0x77, 0x69, 0x6c, 0x6c, 0x20, 0x62,
	0x65, 0x20, 0x72, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x64, 0x20, 0x4a, 0x75, 0x6e, 0x65, 0x20, 0x31,
...
var file_services_provider_v1_provider_proto_goTypes = []interface{}{
	(IonOptions_IonNetwork)(0),                       // 0: services.provider.v1.IonOptions.IonNetwork
	(IndyOptions_IndyNetwork)(0),                     // 1: services.provider.v1.IndyOptions.IndyNetwork
	(*Ecosystem)(nil),                                // 2: services.provider.v1.Ecosystem
	(*CreateEcosystemRequest)(nil),                   // 3: services.provider.v1.CreateEcosystemRequest
	(*CreateEcosystemResponse)(nil),                  // 4: services.provider.v1.CreateEcosystemResponse
	(*UpdateEcosystemRequest)(nil),                   // 5: services.provider.v1.UpdateEcosystemRequest
	(*EcosystemDisplayRequest)(nil),                  // 6: services.provider.v1.EcosystemDisplayRequest
	(*EcosystemDisplayDetailsRequest)(nil),           // 7: services.provider.v1.EcosystemDisplayDetailsRequest
	(*UpdateEcosystemResponse)(nil),                  // 8: services.provider.v1.UpdateEcosystemResponse
	(*EcosystemDisplay)(nil),                         // 9: services.provider.v1.EcosystemDisplay
	(*EcosystemDisplayDetails)(nil),                  // 10: services.provider.v1.EcosystemDisplayDetails
	(*EcosystemInfoRequest)(nil),                     // 11: services.provider.v1.EcosystemInfoRequest
	(*EcosystemInfoResponse)(nil),                    // 12: services.provider.v1.EcosystemInfoResponse
	(*GetOberonKeyRequest)(nil),                      // 13: services.provider.v1.GetOberonKeyRequest
	(*GetOberonKeyResponse)(nil),                     // 14: services.provider.v1.GetOberonKeyResponse
	(*RetrieveDomainVerificationRecordRequest)(nil),  // 15: services.provider.v1.RetrieveDomainVerificationRecordRequest
	(*RetrieveDomainVerificationRecordResponse)(nil), // 16: services.provider.v1.RetrieveDomainVerificationRecordResponse
	(*RefreshDomainVerificationStatusRequest)(nil),   // 17: services.provider.v1.RefreshDomainVerificationStatusRequest
	(*RefreshDomainVerificationStatusResponse)(nil),  // 18: services.provider.v1.RefreshDomainVerificationStatusResponse
	(*SearchWalletConfigurationsRequest)(nil),        // 19: services.provider.v1.SearchWalletConfigurationsRequest
	(*SearchWalletConfigurationResponse)(nil),        // 20: services.provider.v1.SearchWalletConfigurationResponse
	(*WalletConfiguration)(nil),                      // 21: services.provider.v1.WalletConfiguration
	(*IonOptions)(nil),                               // 22: services.provider.v1.IonOptions
	(*IndyOptions)(nil),                              // 23: services.provider.v1.IndyOptions
	(*UpgradeDidRequest)(nil),                        // 24: services.provider.v1.UpgradeDidRequest
	(*UpgradeDidResponse)(nil),                       // 25: services.provider.v1.UpgradeDidResponse
	...
	(*account.WalletAuthToken)(nil),                  // 29: services.account.v1.WalletAuthToken
	(common.SupportedDidMethod)(0),                   // 30: services.common.v1.SupportedDidMethod
}
var file_services_provider_v1_provider_proto_depIdxs = []int32{
	9,  // 0: services.provider.v1.Ecosystem.display:type_name -> services.provider.v1.EcosystemDisplay
	26, // 1: services.provider.v1.CreateEcosystemRequest.details:type_name -> services.account.v1.AccountDetails
	2,  // 2: services.provider.v1.CreateEcosystemResponse.ecosystem:type_name -> services.provider.v1.Ecosystem
	27, // 3: services.provider.v1.CreateEcosystemResponse.profile:type_name -> services.account.v1.AccountProfile
	28, // 4: services.provider.v1.CreateEcosystemResponse.confirmation_method:type_name -> services.account.v1.ConfirmationMethod
	6,  // 5: services.provider.v1.UpdateEcosystemRequest.display:type_name -> services.provider.v1.EcosystemDisplayRequest
	7,  // 6: services.provider.v1.EcosystemDisplayRequest.light:type_name -> services.provider.v1.EcosystemDisplayDetailsRequest
	2,  // 7: services.provider.v1.UpdateEcosystemResponse.Ecosystem:type_name -> services.provider.v1.Ecosystem
	10, // 8: services.provider.v1.EcosystemDisplay.light:type_name -> services.provider.v1.EcosystemDisplayDetails
	2,  // 9: services.provider.v1.EcosystemInfoResponse.ecosystem:type_name -> services.provider.v1.Ecosystem
	21, // 10: services.provider.v1.SearchWalletConfigurationResponse.results:type_name -> services.provider.v1.WalletConfiguration
	29, // 11: services.provider.v1.WalletConfiguration.auth_tokens:type_name -> services.account.v1.WalletAuthToken
	0,  // 12: services.provider.v1.IonOptions.network:type_name -> services.provider.v1.IonOptions.IonNetwork
	1,  // 13: services.provider.v1.IndyOptions.network:type_name -> services.provider.v1.IndyOptions.IndyNetwork
	30, // 14: services.provider.v1.UpgradeDidRequest.method:type_name -> services.common.v1.SupportedDidMethod
	22, // 15: services.provider.v1.UpgradeDidRequest.ion_options:type_name -> services.provider.v1.IonOptions
	23, // 16: services.provider.v1.UpgradeDidRequest.indy_options:type_name -> services.provider.v1.IndyOptions
	3,  // 17: services.provider.v1.Provider.CreateEcosystem:input_type -> services.provider.v1.CreateEcosystemRequest
	5,  // 18: services.provider.v1.Provider.UpdateEcosystem:input_type -> services.provider.v1.UpdateEcosystemRequest
	13, // 19: services.provider.v1.Provider.GetOberonKey:input_type -> services.provider.v1.GetOberonKeyRequest
	24, // 20: services.provider.v1.Provider.UpgradeDID:input_type -> services.provider.v1.UpgradeDidRequest
	15, // 21: services.provider.v1.Provider.RetrieveDomainVerificationRecord:input_type -> services.provider.v1.RetrieveDomainVerificationRecordRequest
	17, // 22: services.provider.v1.Provider.RefreshDomainVerificationStatus:input_type -> services.provider.v1.RefreshDomainVerificationStatusRequest
	19, // 23: services.provider.v1.Provider.SearchWalletConfigurations:input_type -> services.provider.v1.SearchWalletConfigurationsRequest
	4,  // 24: services.provider.v1.Provider.CreateEcosystem:output_type -> services.provider.v1.CreateEcosystemResponse
	8,  // 25: services.provider.v1.Provider.UpdateEcosystem:output_type -> services.provider.v1.UpdateEcosystemResponse
	14, // 26: services.provider.v1.Provider.GetOberonKey:output_type -> services.provider.v1.GetOberonKeyResponse
	25, // 27: services.provider.v1.Provider.UpgradeDID:output_type -> services.provider.v1.UpgradeDidResponse
	16, // 28: services.provider.v1.Provider.RetrieveDomainVerificationRecord:output_type -> services.provider.v1.RetrieveDomainVerificationRecordResponse
	18, // 29: services.provider.v1.Provider.RefreshDomainVerificationStatus:output_type -> services.provider.v1.RefreshDomainVerificationStatusResponse
	20, // 30: services.provider.v1.Provider.SearchWalletConfigurations:output_type -> services.provider.v1.SearchWalletConfigurationResponse
