...
var file_services_verifiable_credentials_v1_verifiable_credentials_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x75, 0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x32, 0xf8, 0x04, 0x0a,
	...
	0x73, 0x65, 0x12, 0x7c, 0x0a, 0x0b, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x50, 0x72, 0x6f, 0x6f,
	...
	0x12, 0x7c, 0x0a, 0x0b, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x12,
	...
	,
...
var file_services_verifiable_credentials_v1_verifiable_credentials_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_services_verifiable_credentials_v1_verifiable_credentials_proto_goTypes = []interface{}{
	...
	(*JsonPayload)(nil),               // 10: services.common.v1.JsonPayload
	(ResponseStatus)(0),               // 11: services.common.v1.ResponseStatus
}
var file_services_verifiable_credentials_v1_verifiable_credentials_proto_depIdxs = []int32{
	10, // 0: services.verifiablecredentials.v1.IssueRequest.document:type_name -> services.common.v1.JsonPayload
	10, // 1: services.verifiablecredentials.v1.IssueResponse.document:type_name -> services.common.v1.JsonPayload
	10, // 2: services.verifiablecredentials.v1.CreateProofRequest.reveal_document:type_name -> services.common.v1.JsonPayload
	10, // 3: services.verifiablecredentials.v1.CreateProofResponse.proof_document:type_name -> services.common.v1.JsonPayload
	10, // 4: services.verifiablecredentials.v1.VerifyProofRequest.proof_document:type_name -> services.common.v1.JsonPayload
	10, // 5: services.verifiablecredentials.v1.SendRequest.didcomm_invitation:type_name -> services.common.v1.JsonPayload
	10, // 6: services.verifiablecredentials.v1.SendRequest.document:type_name -> services.common.v1.JsonPayload
	11, // 7: services.verifiablecredentials.v1.SendResponse.status:type_name -> services.common.v1.ResponseStatus
	0,  // 8: services.verifiablecredentials.v1.VerifiableCredential.Issue:input_type -> services.verifiablecredentials.v1.IssueRequest
	2,  // 9: services.verifiablecredentials.v1.VerifiableCredential.IssueFromTemplate:input_type -> services.verifiablecredentials.v1.IssueFromTemplateRequest
	4,  // 10: services.verifiablecredentials.v1.VerifiableCredential.CreateProof:input_type -> services.verifiablecredentials.v1.CreateProofRequest
	6,  // 11: services.verifiablecredentials.v1.VerifiableCredential.VerifyProof:input_type -> services.verifiablecredentials.v1.VerifyProofRequest
	8,  // 12: services.verifiablecredentials.v1.VerifiableCredential.Send:input_type -> services.verifiablecredentials.v1.SendRequest
	1,  // 13: services.verifiablecredentials.v1.VerifiableCredential.Issue:output_type -> services.verifiablecredentials.v1.IssueResponse
	3,  // 14: services.verifiablecredentials.v1.VerifiableCredential.IssueFromTemplate:output_type -> services.verifiablecredentials.v1.IssueFromTemplateResponse
	5,  // 15: services.verifiablecredentials.v1.VerifiableCredential.CreateProof:output_type -> services.verifiablecredentials.v1.CreateProofResponse
	7,  // 16: services.verifiablecredentials.v1.VerifiableCredential.VerifyProof:output_type -> services.verifiablecredentials.v1.VerifyProofResponse
