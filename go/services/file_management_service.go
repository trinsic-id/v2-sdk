...
type FileManagementService interface {
	...
	// target: /home/runner/work/sdk/sdk/go/services/file_management_service.go
...
// GetStorageStats Deprecated: This method is experimental
// Get statistics about files uploaded by the calling account
func (f *fileManagementBase) GetStorageStats(userContext context.Context) (*filemanagement.GetStorageStatsResponse, error) {
	request := &filemanagement.GetStorageStatsRequest{}
	md, err := f.GetMetadataContext(userContext, request)
	if err != nil {
		return nil, err
	}
