...
type ProviderService interface {
	...
	InviteParticipant(ctx context.Context, request *provider.InviteRequest) (*provider.InviteResponse, error)

// BEGIN Interface Code generated by protoc-gen-trinsic. DO NOT EDIT.
// target: ..\sdk\go\services\provider_service.go

    // CreateEcosystem  Create new ecosystem and assign the authenticated user as owner 
    CreateEcosystem(userContext context.Context, request *provider.CreateEcosystemRequest) (*provider.CreateEcosystemResponse, error)
...
// CreateEcosystem  Create new ecosystem and assign the authenticated user as owner
func (p *providerBase) CreateEcosystem(userContext context.Context, request *provider.CreateEcosystemRequest) (*provider.CreateEcosystemResponse, error) {
    // TODO - Handle a flag for the metadata context
	md, err := p.GetMetadataContext(userContext, request)
    if err != nil {
        return nil, err
    }
    response, err := p.client.CreateEcosystem(md, request)
    if err != nil {
		return nil, err
	}
	return response, nil
