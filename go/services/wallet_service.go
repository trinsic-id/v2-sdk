...
type WalletService interface {
	...
	// target: ..\sdk\go\services\wallet_service.go
...
func (w *walletBase) SearchWallet(userContext context.Context, request *wallet.SearchRequest) (*wallet.SearchResponse, error) {
	if request == nil {
