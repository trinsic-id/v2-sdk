...
// target: ..\sdk\java\src\main\java\trinsic\services\accountService.java
  ...
  public ListenableFuture<AccountOuterClass.AccountInfoResponse> info(AccountOuterClass.AccountInfoRequest request)
      throws InvalidProtocolBufferException, DidException {
    // TODO - Handle metadata
	return withMetadata(stub, request).info(request);
  }

  public ListenableFuture<AccountOuterClass.ListDevicesResponse> listDevices(AccountOuterClass.ListDevicesRequest request)
      throws InvalidProtocolBufferException, DidException {
    // TODO - Handle metadata
	return withMetadata(stub, request).listDevices(request);
  }

  public ListenableFuture<AccountOuterClass.RevokeDeviceResponse> revokeDevice(AccountOuterClass.RevokeDeviceRequest request)
      throws InvalidProtocolBufferException, DidException {
    // TODO - Handle metadata
	return withMetadata(stub, request).revokeDevice(request);
  }

  public ListenableFuture<AccountOuterClass.AuthorizeWebhookResponse> authorizeWebhook(AccountOuterClass.AuthorizeWebhookRequest request)
      throws InvalidProtocolBufferException, DidException {
    // TODO - Handle metadata
