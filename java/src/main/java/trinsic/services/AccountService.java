...
public class AccountService extends ServiceBase {
    ...
    public static String unprotect(String base64Profile, String securityCode) throws InvalidProtocolBufferException, DidException {
        ...
        profile = AccountProfile.newBuilder(profile).setAuthToken(result.getToken()).setProtection(TokenProtection.newBuilder().setMethod(ConfirmationMethod.None).setEnabled(false).build()).build();
    ...
    public static String protect(String base64Profile, String securityCode) throws InvalidProtocolBufferException, DidException {
        ...
        profile = AccountProfile.newBuilder(profile).setAuthToken(result.getToken()).setProtection(TokenProtection.newBuilder().setMethod(ConfirmationMethod.Other).setEnabled(true).build()).build();
        return Base64.getUrlEncoder().encodeToString(profile.toByteArray());
    }
    ...
    public ListenableFuture<LoginResponse> login(LoginRequest request) throws InvalidProtocolBufferException, DidException {
    ...
    public ListenableFuture<String> loginConfirm(ByteString challenge, String authCode) throws InvalidProtocolBufferException, DidException {
        var hashed = Hashing.blake3_hash(trinsic.okapi.hashing.v1.Hashing.Blake3HashRequest.newBuilder().setData(ByteString.copyFrom(authCode.getBytes(StandardCharsets.UTF_8))).build()).getDigest();

        var request = LoginConfirmRequest.newBuilder().setChallenge(challenge).setConfirmationCodeHashed(hashed).build();
    ...
    public ListenableFuture<String> loginAnonymous(String ecosystemId) throws InvalidProtocolBufferException, DidException, ExecutionException, InterruptedException {
    ...
    public ListenableFuture<AccountInfoResponse> getInfo() throws InvalidProtocolBufferException, DidException {
     ...
     */
    public ListenableFuture<AccountInfoResponse> info() throws InvalidProtocolBufferException, DidException {
        var request = AccountInfoRequest.newBuilder().build();
        return withMetadata(stub, request).info(request);
    }
     ...
     */
    public ListenableFuture<ListDevicesResponse> listDevices(ListDevicesRequest request) throws InvalidProtocolBufferException, DidException {
     ...
     */
    public ListenableFuture<RevokeDeviceResponse> revokeDevice(RevokeDeviceRequest request) throws InvalidProtocolBufferException, DidException {
     ...
     */
    public ListenableFuture<AuthorizeWebhookResponse> authorizeWebhook(AuthorizeWebhookRequest request) throws InvalidProtocolBufferException, DidException {
