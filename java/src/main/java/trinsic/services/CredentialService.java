...
public class CredentialService extends ServiceBase {
  ...
  public ListenableFuture<IssueResponse> issueCredential(IssueRequest request)
  ...
  public ListenableFuture<IssueFromTemplateResponse> issueCredentialFromTemplate(
