...
public class CredentialService extends ServiceBase {
  ...
  public ListenableFuture<CreateCredentialOfferResponse> createCredentialOffer(
      CreateCredentialOfferRequest request) throws InvalidProtocolBufferException {

    return withMetadata(stub, request).createCredentialOffer(request);
  }
  /** Accept an offer to exchange a credential */
  public ListenableFuture<AcceptCredentialResponse> acceptCredential(
      AcceptCredentialRequest request) throws InvalidProtocolBufferException {

    return withMetadata(stub, request).acceptCredential(request);
  }
  /** Reject an offer to exchange a credential */
  public ListenableFuture<RejectCredentialResponse> rejectCredential(
      RejectCredentialRequest request) throws InvalidProtocolBufferException {
