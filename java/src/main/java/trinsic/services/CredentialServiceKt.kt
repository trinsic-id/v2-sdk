...
// target: C:\work\sdk\java\src\main\java\trinsic\services\CredentialServiceKt.kt
...
*/
  ...
  suspend fun acceptCredential(request: AcceptCredentialRequest): AcceptCredentialResponse {
  ...
  suspend fun rejectCredential(request: RejectCredentialRequest): RejectCredentialResponse {
