...
// target: C:\work\sdk\java\src\main\java\trinsic\services\FileManagementService.java
...
* Get statistics about files uploaded by the calling account */
  @Deprecated(since = "This method is experimental")
  public ListenableFuture<GetStorageStatsResponse> getStorageStats()
      throws InvalidProtocolBufferException {
    var request = GetStorageStatsRequest.newBuilder().build();
