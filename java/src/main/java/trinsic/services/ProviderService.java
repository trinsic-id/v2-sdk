...
// target: C:\work\sdk\java\src\main\java\trinsic\services\ProviderService.java
  ...
  public ListenableFuture<RetrieveVerificationRecordResponse> retrieveVerificationRecord(RetrieveVerificationRecordRequest request)
      throws InvalidProtocolBufferException, DidException {
    // TODO - Handle metadata
	return withMetadata(stub, request).retrieveVerificationRecord(request);
  }
  public ListenableFuture<RefreshVerificationStatusResponse> refreshVerificationStatus(RefreshVerificationStatusRequest request)
      throws InvalidProtocolBufferException, DidException {
    // TODO - Handle metadata
