...
// target: C:\work\sdk\java\src\main\java\trinsic\services\ProviderServiceKt.kt
  ...
  @Throws(InvalidProtocolBufferException::class, DidException::class)
  suspend fun getPublicEcosystemInfo(request: GetPublicEcosystemInfoRequest): GetPublicEcosystemInfoResponse {
...
*/
  ...
  @Throws(InvalidProtocolBufferException::class, DidException::class)
  suspend fun refreshDomainVerificationStatus(request: RefreshDomainVerificationStatusRequest): RefreshDomainVerificationStatusResponse {
