...
*/
  ...
  @Throws(InvalidProtocolBufferException::class, DidException::class)
  suspend fun revokeAuthorization(request: RevokeAuthorizationRequest): RevokeAuthorizationResponse {
...
*/
  ...
  @Throws(InvalidProtocolBufferException::class, DidException::class)
  suspend fun retrieveVerificationRecord(request: RetrieveVerificationRecordRequest): RetrieveVerificationRecordResponse {
...
*/
  ...
  @Throws(InvalidProtocolBufferException::class, DidException::class)
  suspend fun refreshVerificationStatus(request: RefreshVerificationStatusRequest): RefreshVerificationStatusResponse {
	 /**  Call to verif
*/
    // TODO - Support metadata anonymous
