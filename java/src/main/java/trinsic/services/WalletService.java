...
// target: C:\work\sdk\java\src\main\java\trinsic\services\WalletService.java
  ...
  public ListenableFuture<GetMyInfoResponse> getMyInfo()
      throws InvalidProtocolBufferException {
...
* existing auth token. */
  ...
  public ListenableFuture<GenerateAuthTokenResponse> generateAuthToken(GenerateAuthTokenRequest request)
      throws InvalidProtocolBufferException {
...
* This identity ownership must be confirmed using `AddIdentityConfirm` via OTP, signature, etc. */
  ...
  public ListenableFuture<AddExternalIdentityInitResponse> addExternalIdentityInit(AddExternalIdentityInitRequest request)
      throws InvalidProtocolBufferException {
  ...
  public ListenableFuture<AddExternalIdentityConfirmResponse> addExternalIdentityConfirm(AddExternalIdentityConfirmRequest request)
      throws InvalidProtocolBufferException {
  ...
  public ListenableFuture<RemoveExternalIdentityResponse> removeExternalIdentity(RemoveExternalIdentityRequest request)
      throws InvalidProtocolBufferException {
...
* This endpoint does not require authentication, and will return a challenge to be signed or verified */
  ...
  public ListenableFuture<AuthenticateInitResponse> authenticateInit(AuthenticateInitRequest request)
      throws InvalidProtocolBufferException {
  ...
  public ListenableFuture<AuthenticateConfirmResponse> authenticateConfirm(AuthenticateConfirmRequest request)
      throws InvalidProtocolBufferException {
  ...
  public ListenableFuture<AuthenticateResendCodeResponse> authenticateResendCode(AuthenticateResendCodeRequest request)
      throws InvalidProtocolBufferException {
  ...
  public ListenableFuture<ListByVerificationTemplateResponse> listByVerificationTemplate(ListByVerificationTemplateRequest request)
      throws InvalidProtocolBufferException {
