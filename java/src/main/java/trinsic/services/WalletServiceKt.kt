...
// target: C:\work\sdk\java\src\main\java\trinsic\services\WalletServiceKt.kt
...
*/
  ...
  suspend fun addExternalIdentityInit(request: AddExternalIdentityInitRequest): AddExternalIdentityInitResponse {
...
*/
  ...
  suspend fun addExternalIdentityConfirm(request: AddExternalIdentityConfirmRequest): AddExternalIdentityConfirmResponse {
  ...
  suspend fun removeExternalIdentity(request: RemoveExternalIdentityRequest): RemoveExternalIdentityResponse {
...
*/
  ...
  suspend fun authenticateConfirm(request: AuthenticateConfirmRequest): AuthenticateConfirmResponse {
  ...
  suspend fun authenticateResendCode(request: AuthenticateResendCodeRequest): AuthenticateResendCodeResponse {
  ...
  suspend fun listByVerificationTemplate(request: ListByVerificationTemplateRequest): ListByVerificationTemplateResponse {
