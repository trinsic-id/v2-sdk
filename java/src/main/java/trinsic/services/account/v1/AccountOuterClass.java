  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "kRequest\032-.services.account.v1.AuthorizeWebhookResponseBZ\n"
          + "\033trinsic.services.account.v1P\001Z\033services/account/v1/account\252\002\033"
          + "Trinsic.Services.Account.V1b\006proto3"
    };
    descriptor =
