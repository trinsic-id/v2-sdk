...
public interface EcosystemOrBuilder
   ...
   */
  java.util.List<trinsic.services.common.v1.WebhookConfig> getWebhooksList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .services.provider.v1.WebhookConfig webhooks = 5;</code>
   */
  trinsic.services.common.v1.WebhookConfig getWebhooks(int index);
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .services.provider.v1.WebhookConfig webhooks = 5;</code>
   */
  java.util.List<? extends trinsic.services.common.v1.WebhookConfigOrBuilder>
   ...
   * <code>repeated .services.provider.v1.WebhookConfig webhooks = 5;</code>
   */
  trinsic.services.common.v1.WebhookConfigOrBuilder getWebhooksOrBuilder(int index);
}
