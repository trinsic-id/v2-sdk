...
public interface ListFilesResponseOrBuilder
   ...
   */
  java.util.List<trinsic.services.filemanagement.v1.File> getFilesList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .services.filemanagement.v1.File files = 1;</code>
   */
  trinsic.services.filemanagement.v1.File getFiles(int index);
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .services.filemanagement.v1.File files = 1;</code>
   */
  java.util.List<? extends trinsic.services.filemanagement.v1.FileOrBuilder>
   ...
   * <code>repeated .services.filemanagement.v1.File files = 1;</code>
   */
  trinsic.services.filemanagement.v1.FileOrBuilder getFilesOrBuilder(int index);
