 ...
 */
public final class EcosystemDisplayRequest extends
...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          case 0:
            ...
            break;
          case 10: {
            trinsic.services.provider.v1.EcosystemDisplayDetailsRequest.Builder subBuilder = null;
            if (dark_ != null) {
              subBuilder = dark_.toBuilder();
            }
            dark_ = input.readMessage(trinsic.services.provider.v1.EcosystemDisplayDetailsRequest.parser(), extensionRegistry);
            if (subBuilder != null) {
          ...
          case 18: {
            ...
            light_ = input.readMessage(trinsic.services.provider.v1.EcosystemDisplayDetailsRequest.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return trinsic.services.provider.v1.ProviderOuterClass.internal_static_services_provider_v1_EcosystemDisplayRequest_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return trinsic.services.provider.v1.ProviderOuterClass.internal_static_services_provider_v1_EcosystemDisplayRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            trinsic.services.provider.v1.EcosystemDisplayRequest.class, trinsic.services.provider.v1.EcosystemDisplayRequest.Builder.class);
  }
  ...
  public trinsic.services.provider.v1.EcosystemDisplayDetailsRequest getDark() {
    return dark_ == null ? trinsic.services.provider.v1.EcosystemDisplayDetailsRequest.getDefaultInstance() : dark_;
  }
  /**
   * <code>.services.provider.v1.EcosystemDisplayDetailsRequest dark = 1;</code>
   */
  ...
  public trinsic.services.provider.v1.EcosystemDisplayDetailsRequest getLight() {
    return light_ == null ? trinsic.services.provider.v1.EcosystemDisplayDetailsRequest.getDefaultInstance() : light_;
  }
  /**
   * <code>.services.provider.v1.EcosystemDisplayDetailsRequest light = 2;</code>
   */
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    trinsic.services.provider.v1.EcosystemDisplayRequest other = (trinsic.services.provider.v1.EcosystemDisplayRequest) obj;
  ...
  public static trinsic.services.provider.v1.EcosystemDisplayRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static trinsic.services.provider.v1.EcosystemDisplayRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static final class Builder extends
    ...
    public trinsic.services.provider.v1.EcosystemDisplayRequest buildPartial() {
      trinsic.services.provider.v1.EcosystemDisplayRequest result = new trinsic.services.provider.v1.EcosystemDisplayRequest(this);
      if (darkBuilder_ == null) {
        result.dark_ = dark_;
      } else {
    ...
    public Builder mergeFrom(trinsic.services.provider.v1.EcosystemDisplayRequest other) {
      if (other == trinsic.services.provider.v1.EcosystemDisplayRequest.getDefaultInstance()) return this;
      if (other.hasDark()) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      trinsic.services.provider.v1.EcosystemDisplayRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (trinsic.services.provider.v1.EcosystemDisplayRequest) e.getUnfinishedMessage();
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        trinsic.services.provider.v1.EcosystemDisplayDetailsRequest, trinsic.services.provider.v1.EcosystemDisplayDetailsRequest.Builder, trinsic.services.provider.v1.EcosystemDisplayDetailsRequestOrBuilder> darkBuilder_;
    /**
     * <code>.services.provider.v1.EcosystemDisplayDetailsRequest dark = 1;</code>
     * @return Whether the dark field is set.
     */
    ...
    public Builder mergeDark(trinsic.services.provider.v1.EcosystemDisplayDetailsRequest value) {
      if (darkBuilder_ == null) {
        if (dark_ != null) {
          dark_ =
            trinsic.services.provider.v1.EcosystemDisplayDetailsRequest.newBuilder(dark_).mergeFrom(value).buildPartial();
        } else {
          dark_ = value;
        }
        onChanged();
    ...
    public trinsic.services.provider.v1.EcosystemDisplayDetailsRequestOrBuilder getDarkOrBuilder() {
      if (darkBuilder_ != null) {
        ...
        return dark_ == null ?
            trinsic.services.provider.v1.EcosystemDisplayDetailsRequest.getDefaultInstance() : dark_;
      }
    }
    /**
     * <code>.services.provider.v1.EcosystemDisplayDetailsRequest dark = 1;</code>
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        trinsic.services.provider.v1.EcosystemDisplayDetailsRequest, trinsic.services.provider.v1.EcosystemDisplayDetailsRequest.Builder, trinsic.services.provider.v1.EcosystemDisplayDetailsRequestOrBuilder> 
        getDarkFieldBuilder() {
      if (darkBuilder_ == null) {
    ...
    private trinsic.services.provider.v1.EcosystemDisplayDetailsRequest light_;
    private com.google.protobuf.SingleFieldBuilderV3<
        trinsic.services.provider.v1.EcosystemDisplayDetailsRequest, trinsic.services.provider.v1.EcosystemDisplayDetailsRequest.Builder, trinsic.services.provider.v1.EcosystemDisplayDetailsRequestOrBuilder> lightBuilder_;
    /**
     * <code>.services.provider.v1.EcosystemDisplayDetailsRequest light = 2;</code>
     * @return Whether the light field is set.
     */
    ...
    public Builder mergeLight(trinsic.services.provider.v1.EcosystemDisplayDetailsRequest value) {
      if (lightBuilder_ == null) {
        if (light_ != null) {
          light_ =
            trinsic.services.provider.v1.EcosystemDisplayDetailsRequest.newBuilder(light_).mergeFrom(value).buildPartial();
        } else {
          light_ = value;
        }
        onChanged();
    ...
    public trinsic.services.provider.v1.EcosystemDisplayDetailsRequestOrBuilder getLightOrBuilder() {
      if (lightBuilder_ != null) {
        ...
        return light_ == null ?
            trinsic.services.provider.v1.EcosystemDisplayDetailsRequest.getDefaultInstance() : light_;
      }
    }
    /**
     * <code>.services.provider.v1.EcosystemDisplayDetailsRequest light = 2;</code>
  ...
  private static final com.google.protobuf.Parser<EcosystemDisplayRequest>
      PARSER = new com.google.protobuf.AbstractParser<EcosystemDisplayRequest>() {
    @java.lang.Override
    public EcosystemDisplayRequest parsePartialFrom(
        com.google.protobuf.CodedInputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return new EcosystemDisplayRequest(input, extensionRegistry);
    }
  };
