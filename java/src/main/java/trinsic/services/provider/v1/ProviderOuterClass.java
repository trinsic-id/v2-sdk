  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "\007display\030\005 \001(\0132-.services.provider.v1.EcosystemDisplayRequest\"^\n"
          ...
          + "\tecosystem\030\001 \001(\01320.services.p"
          + "rovider.v1.PublicEcosystemInformation\"\247\001\n"
          ...
          + "\010Provider\022v\n"
          + "\017CreateEcosystem\022,.services.provider.v1.CreateEcosystemReques"
          + "t\032-.services.provider.v1.CreateEcosystemResponse\"\006\212\246\035\002\020\001\022n\n"
          + "\017UpdateEcosystem\022,.services.provider.v1.UpdateEcosystemReques"
          + "t\032-.services.provider.v1.UpdateEcosystemResponse\022w\n"
          + "\022GrantAuthorization\022/.services.provider.v1.GrantAuthorizationRequest\032"
          + "0.services.provider.v1.GrantAuthorizationResponse\022z\n"
          + "\023RevokeAuthorization\0220.services.provider.v1.RevokeAuthorizationReque"
          + "st\0321.services.provider.v1.RevokeAuthorizationResponse\022t\n"
          + "\021GetAuthorizations\022..services.provider.v1.GetAuthorizationsReque"
          + "st\032/.services.provider.v1.GetAuthorizationsResponse\022_\n\n"
          + "AddWebhook\022\'.services.pro"
          + "vider.v1.AddWebhookRequest\032(.services.provider.v1.AddWebhookResponse\022h\n\r"
          + "DeleteWebhook\022*.services.provider.v1.DeleteWebho"
          + "okRequest\032+.services.provider.v1.DeleteWebhookResponse\022h\n\r"
          + "EcosystemInfo\022*.services.provider.v1.EcosystemInfoRequest\032+.se"
          + "rvices.provider.v1.EcosystemInfoResponse\022\213\001\n"
          + "\026GetPublicEcosystemInfo\0223.services.provider.v1.GetPublicEcosystemInfoRequest"
          + "\0324.services.provider.v1.GetPublicEcosystemInfoResponse\"\006\212\246\035\002\010\001\022h\n\r"
          + "GenerateToken\022*.services.provider.v1.GenerateTokenRequ"
          + "est\032+.services.provider.v1.GenerateTokenResponse\022^\n"
          + "\006Invite\022#.services.provider.v"
          + "1.InviteRequest\032$.services.provider.v1.InviteResponse\""
          + "\t\210\002\001\212\246\035\002\020\001\022|\n"
          + "\020InvitationStatus\022-.services.provider.v1.InvitationSt"
          + "atusRequest\032..services.provider.v1.InvitationStatusResponse\""
          + "\t\210\002\001\212\246\035\002\020\001\022m\n"
          + "\014GetOberonKey\022).services.provider.v1.GetOberonK"
          + "eyRequest\032*.services.provider.v1.GetOberonKeyResponse\"\006\212\246\035\002\010\001\022h\n\r"
          + "GetEventToken\022*.services.provider.v1.GetEventTokenReque"
          + "st\032+.services.provider.v1.GetEventTokenResponse\022_\n\n"
          + "UpgradeDID\022\'.services.provide"
          + "r.v1.UpgradeDidRequest\032(.services.provider.v1.UpgradeDidResponse\022\251\001\n"
          + " RetrieveDomainVerificationRecord\022=.services.provide"
          + "r.v1.RetrieveDomainVerificationRecordReq"
          + "uest\032>.services.provider.v1.RetrieveDomainVerificationRecordResponse\"\006\212\246\035\002\030\001\022\236\001\n"
          + "\037RefreshDomainVerificationStatus\022<.services.provider.v1.RefreshDomainVerificatio"
          + "nStatusRequest\032=.services.provider.v1.Re"
          + "freshDomainVerificationStatusResponse\022\216\001\n"
          + "\032SearchWalletConfigurations\0227.services.provider.v1.SearchWalletConfigurationsRe"
          + "quest\0327.services.provider.v1.SearchWalletConfigurationResponseB^\n"
          + "\034trinsic.services.provider.v1P\001Z\035services/provider/v1/p"
          + "rovider\252\002\034Trinsic.Services.Provider.V1b\006proto3"
    };
    descriptor =
