  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "CreateEcosystemRequest\032-.services.provider.v1.CreateEcosystemResponse\"\006\212\246\035\002\020\001\022n\n"
          + "\017UpdateEcosystem\022,.services.provider.v1."
          + "UpdateEcosystemRequest\032-.services.provider.v1.UpdateEcosystemResponse\022w\n"
          + "\022GrantAuthorization\022/.services.provider.v1.Grant"
          + "AuthorizationRequest\0320.services.provider.v1.GrantAuthorizationResponse\022z\n"
          + "\023RevokeAuthorization\0220.services.provider.v1.Rev"
          + "okeAuthorizationRequest\0321.services.provider.v1.RevokeAuthorizationResponse\022t\n"
          + "\021GetAuthorizations\022..services.provider.v1.G"
          + "etAuthorizationsRequest\032/.services.provider.v1.GetAuthorizationsResponse\022_\n\n"
          + "AddWebhook\022\'.services.provider.v1.AddWebhook"
          + "Request\032(.services.provider.v1.AddWebhookResponse\022h\n\r"
          + "DeleteWebhook\022*.services.pr"
          + "ovider.v1.DeleteWebhookRequest\032+.services.provider.v1.DeleteWebhookResponse\022h\n\r"
          + "EcosystemInfo\022*.services.provider.v1.Ecos"
          + "ystemInfoRequest\032+.services.provider.v1.EcosystemInfoResponse\022\213\001\n"
          + "\026GetPublicEcosystemInfo\0223.services.provider.v1.GetPubli"
          + "cEcosystemInfoRequest\0324.services.provide"
          + "r.v1.GetPublicEcosystemInfoResponse\"\006\212\246\035\002\010\001\022h\n\r"
          ...
          + "\020InvitationStatus\022-.services.provider.v1.In"
          + "vitationStatusRequest\032..services.provider.v1.InvitationStatusResponse\022m\n"
          + "\014GetOberonKey\022).services.provider.v1.GetOberonKe"
          + "yRequest\032*.services.provider.v1.GetOberonKeyResponse\"\006\212\246\035\002\010\001\022h\n\r"
          + "GetEventToken\022*.services.provider.v1.GetEventTokenReques"
          + "t\032+.services.provider.v1.GetEventTokenResponse\022_\n\n"
          ...
          + "est\032>.services.provider.v1.RetrieveDomainVerificationRecordResponse\"\006\212\246\035\002\030\001\022\236\001\n"
          + "\037RefreshDomainVerificationStatus\022<.servic"
          + "es.provider.v1.RefreshDomainVerification"
          + "StatusRequest\032=.services.provider.v1.RefreshDomainVerificationStatusResponse\022\216\001\n"
