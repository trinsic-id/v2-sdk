  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "\022continuation_token\030\004 \001(\t\"\337\001\n"
          ...
          + "\023external_identities\030\010 \003(\t\"r\n\n"
          + "IonOptions\022<\n"
          ...
          + "\010Provider\022v\n"
          + "\017CreateEcosystem\022,.services.provider.v1.Create"
          + "EcosystemRequest\032-.services.provider.v1.CreateEcosystemResponse\"\006\212\246\035\002\020\001\022\235\001\n"
          + "\017UpdateEcosystem\022,.services.provider.v1.Updat"
          + "eEcosystemRequest\032-.services.provider.v1.UpdateEcosystemResponse\"-\210\002\001\212\246\035&*$\010\001\022"
          + " This will be removed May 1, 2023\022g\n\n"
          + "AddWebhook\022\'.services.provider.v1.AddWebhookR"
          + "equest\032(.services.provider.v1.AddWebhookResponse\"\006\212\246\035\002\020\001\022p\n\r"
          + "DeleteWebhook\022*.services.provider.v1.DeleteWebhookRequest\032+."
          + "services.provider.v1.DeleteWebhookResponse\"\006\212\246\035\002\020\001\022h\n\r"
          + "EcosystemInfo\022*.services.p"
          + "rovider.v1.EcosystemInfoRequest\032+.services.provider.v1.EcosystemInfoResponse\022\265\001\n"
          + "\026GetPublicEcosystemInfo\0223.services.provi"
          + "der.v1.GetPublicEcosystemInfoRequest\0324.s"
          + "ervices.provider.v1.GetPublicEcosystemInfoResponse\"0\212\246\035\002\010\001\212\246\035&*$\010\001\022"
          + " This will be removed May 1, 2023\022\210\001\n"
          + "\006Invite\022#.services.provider.v1.InviteRequest\032$.services."
          + "provider.v1.InviteResponse\"3\210\002\001\212\246\035&*$\010\001\022 This will be"
          + " removed May 1, 2023\212\246\035\002\020\001\022\246\001\n"
          + "\020InvitationStatus\022-.services.provider.v1.InvitationStatusRequest\032..services.p"
          + "rovider.v1.InvitationStatusResponse\"3\210\002\001\212\246\035&*$\010\001\022 This"
          + " will be removed May 1, 2023\212\246\035\002\020\001\022s\n"
          + "\014GetOberonKey\022).services.provider.v1.GetOberonKeyRequest\032*.services.p"
          + "rovider.v1.GetOberonKeyResponse\"\014\212\246\035\002\010\001\212\246\035\002\030\001\022_\n\n"
          + "UpgradeDID\022\'.services.provider."
          + "v1.UpgradeDidRequest\032(.services.provider.v1.UpgradeDidResponse\022\251\001\n"
          + " RetrieveDomainVerificationRecord\022=.services.provider."
          + "v1.RetrieveDomainVerificationRecordReque"
          + "st\032>.services.provider.v1.RetrieveDomainVerificationRecordResponse\"\006\212\246\035\002\030\001\022\246\001\n"
          + "\037RefreshDomainVerificationStatus\022<.service"
          + "s.provider.v1.RefreshDomainVerificationStatusRequest\032=.services.provider.v1.Refr"
          + "eshDomainVerificationStatusResponse\"\006\212\246\035\002\030\001\022\216\001\n"
          + "\032SearchWalletConfigurations\0227.services.provider.v1.SearchWalletConfigurat"
          + "ionsRequest\0327.services.provider.v1.SearchWalletConfigurationResponseB^\n"
          + "\034trinsic.services.provider.v1P\001Z\035services/provide"
          + "r/v1/provider\252\002\034Trinsic.Services.Provider.V1b\006proto3"
    };
    descriptor =
