...
public interface GetWalletFromExternalIdentityResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:services.universalwallet.v1.GetWalletFromExternalIdentityResponse)
