...
class AccountService(ServiceBase):
    ...
    async def sign_in(self, *, request: SignInRequest) -> SignInResponse:
        ...
        """
        return await self.client.sign_in(request)
    ...
    async def login_confirm(
        self, *, request: LoginConfirmRequest
    ...
    async def info(self, *, request: AccountInfoRequest) -> AccountInfoResponse:
        ...
        """
        return await self.client.info(request)

    async def list_devices(self, *, request: ListDevicesRequest) -> ListDevicesResponse:
        """
        List all connected devices
        """
        return await self.client.list_devices(request)
    ...
    async def revoke_device(
        ...
        """
        return await self.client.revoke_device(request)
    ...
    async def authorize_webhook(
        ...
        """
        return await self.client.authorize_webhook(request)
