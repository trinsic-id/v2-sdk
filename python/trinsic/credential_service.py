...
class CredentialService(ServiceBase):
    ...
    # target: /home/runner/work/sdk/sdk/python/trinsic/credential_service.py

    @deprecation.deprecated(details="This endpoint will be removed around June 1, 2023")
    async def issue(self, *, request: IssueRequest) -> IssueResponse:
        """
        This endpoint will be removed around June 1, 2023
