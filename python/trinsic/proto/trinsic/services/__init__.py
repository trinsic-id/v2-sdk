...
# sources: AuthService.proto, CoreService.proto, IssuerService.proto, ProviderService.proto, WalletService.proto
...
class NoOp(betterproto.Message):
    pass


@dataclass(eq=False, repr=False)
class AcquireTokenRequest(betterproto.Message):
    signed_message: "__pbmse__.SignedMessage" = betterproto.message_field(1)


@dataclass(eq=False, repr=False)
class AcquireTokenResponse(betterproto.Message):
    status: "ResponseStatus" = betterproto.enum_field(1)
    wallet_token: str = betterproto.string_field(2)
...
class CreateProofRequest(betterproto.Message):
    ...
    reveal_document: "betterproto_lib_google_protobuf.Struct" = (
...
class CreateProofResponse(betterproto.Message):
    proof_document: "betterproto_lib_google_protobuf.Struct" = (
        betterproto.message_field(1)
    )
...
class SendRequest(betterproto.Message):
    ...
    didcomm_invitation: "betterproto_lib_google_protobuf.Struct" = (
        betterproto.message_field(3, group="delivery_method")
    )
    document: "betterproto_lib_google_protobuf.Struct" = betterproto.message_field(100)
...
class SearchResponse(betterproto.Message):
    items: List["betterproto_lib_google_protobuf.Struct"] = betterproto.message_field(1)
    has_more: bool = betterproto.bool_field(2)


@dataclass(eq=False, repr=False)
class InsertItemRequest(betterproto.Message):
    item: "betterproto_lib_google_protobuf.Struct" = betterproto.message_field(1)
...
class AuthenticationStub(betterproto.ServiceStub):
    async def acquire_token(
        self, *, signed_message: "__pbmse__.SignedMessage" = None
    ) -> "AcquireTokenResponse":

        request = AcquireTokenRequest()
        if signed_message is not None:
            request.signed_message = signed_message
...
class CredentialStub(betterproto.ServiceStub):
    async def issue(
        self, *, document: "betterproto_lib_google_protobuf.Struct" = None
    ) -> "IssueResponse":
    ...
    async def create_proof(
        self,
        *,
        reveal_document: "betterproto_lib_google_protobuf.Struct" = None,
        document_id: str = "",
    ) -> "CreateProofResponse":
    ...
    async def verify_proof(
        self, *, proof_document: "betterproto_lib_google_protobuf.Struct" = None
    ) -> "VerifyProofResponse":
    ...
    async def send(
        ...
        *,
        email: str = "",
        did_uri: str = "",
        didcomm_invitation: "betterproto_lib_google_protobuf.Struct" = None,
        document: "betterproto_lib_google_protobuf.Struct" = None,
    ) -> "SendResponse":
...
class WalletStub(betterproto.ServiceStub):
    ...
    async def insert_item(
        self,
        *,
        item: "betterproto_lib_google_protobuf.Struct" = None,
        item_type: str = "",
    ) -> "InsertItemResponse":
...
class AuthenticationBase(ServiceBase):
    async def acquire_token(
        self, signed_message: "__pbmse__.SignedMessage"
    ) -> "AcquireTokenResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def __rpc_acquire_token(self, stream: grpclib.server.Stream) -> None:
        request = await stream.recv_message()
        ...
        response = await self.acquire_token(**request_kwargs)
        await stream.send_message(response)

    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            "/trinsic.services.Authentication/AcquireToken": grpclib.const.Handler(
                self.__rpc_acquire_token,
                grpclib.const.Cardinality.UNARY_UNARY,
                AcquireTokenRequest,
                AcquireTokenResponse,
            ),
...
class CredentialBase(ServiceBase):
    async def issue(
        self, document: "betterproto_lib_google_protobuf.Struct"
    ) -> "IssueResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def verify_proof(
        self, proof_document: "betterproto_lib_google_protobuf.Struct"
    ) -> "VerifyProofResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def send(
        ...
        did_uri: str,
        didcomm_invitation: "betterproto_lib_google_protobuf.Struct",
        document: "betterproto_lib_google_protobuf.Struct",
    ) -> "SendResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
...
class WalletBase(ServiceBase):
    ...
    async def insert_item(
        self, item: "betterproto_lib_google_protobuf.Struct", item_type: str
    ) -> "InsertItemResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
