...
# sources: CoreService.proto, DebugService.proto, IssuerService.proto, ProviderService.proto, TrustRegistry.proto, WalletService.proto, models/CredentialTemplates.proto
...
class SearchRegistryRequest(betterproto.Message):
    ...
    options: "RequestOptions" = betterproto.message_field(5)
...
class RegisterIssuerRequest(betterproto.Message):
    ...
    options: "RequestOptions" = betterproto.message_field(100)


@dataclass(eq=False, repr=False)
class RegisterIssuerResponse(betterproto.Message):
    status: "ResponseStatus" = betterproto.enum_field(1)
    response_data: "JsonPayload" = betterproto.message_field(2)
...
class UnregisterMemberRequest(betterproto.Message):
    ...
    x509_cert: str = betterproto.string_field(2, group="member")
    template_uri: str = betterproto.string_field(10, group="template")
    context_uri: str = betterproto.string_field(11, group="template")
...
class FetchDataResponse(betterproto.Message):
    response: "JsonPayload" = betterproto.message_field(1)
...
class CredentialTemplate(betterproto.Message):
    ...
    description: str = betterproto.string_field(3)
    contexts: List[str] = betterproto.string_field(4)
...
class DebuggingStub(betterproto.ServiceStub):
    ...
    async def call_empty_auth(self) -> "betterproto_lib_google_protobuf.Empty":

        request = betterproto_lib_google_protobuf.Empty()

        return await self._unary_unary(
            "/trinsic.services.Debugging/CallEmptyAuth",
            request,
            betterproto_lib_google_protobuf.Empty,
        )
...
class TrustRegistryStub(betterproto.ServiceStub):
    ...
    async def unregister_member(
        ...
        *,
        ...
        request.did_uri = did_uri
        request.x509_cert = x509_cert
        request.template_uri = template_uri
    ...
    async def fetch_data(
        ...
        async for response in self._unary_stream(
            "/trinsic.services.TrustRegistry/FetchData",
            request,
            FetchDataResponse,
        ):
            yield response
...
class DebuggingBase(ServiceBase):
    ...
    async def __rpc_call_empty_auth(self, stream: grpclib.server.Stream) -> None:
        request = await stream.recv_message()

        request_kwargs = {}

        response = await self.call_empty_auth(**request_kwargs)
        await stream.send_message(response)
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            ...
            "/trinsic.services.Debugging/CallEmptyAuth": grpclib.const.Handler(
                self.__rpc_call_empty_auth,
                grpclib.const.Cardinality.UNARY_UNARY,
                betterproto_lib_google_protobuf.Empty,
                betterproto_lib_google_protobuf.Empty,
            ),
...
class TrustRegistryBase(ServiceBase):
    ...
    async def search_registry(
        self, query: str, continuation_token: str, options: "RequestOptions"
    ) -> "SearchRegistryResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def unregister_member(
        self, did_uri: str, x509_cert: str, template_uri: str, context_uri: str
    ) -> "UnregisterMemberResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def __rpc_unregister_member(self, stream: grpclib.server.Stream) -> None:
        ...
        request_kwargs = {
            "did_uri": request.did_uri,
            "x509_cert": request.x509_cert,
            "template_uri": request.template_uri,
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            "/trinsic.services.TrustRegistry/AddFramework": grpclib.const.Handler(
                self.__rpc_add_framework,
                grpclib.const.Cardinality.UNARY_UNARY,
                AddFrameworkRequest,
                AddFrameworkResponse,
            ),
            "/trinsic.services.TrustRegistry/RemoveFramework": grpclib.const.Handler(
                self.__rpc_remove_framework,
                grpclib.const.Cardinality.UNARY_UNARY,
                RemoveFrameworkRequest,
                RemoveFrameworkResponse,
            ),
            "/trinsic.services.TrustRegistry/SearchRegistry": grpclib.const.Handler(
                self.__rpc_search_registry,
                grpclib.const.Cardinality.UNARY_UNARY,
                SearchRegistryRequest,
                SearchRegistryResponse,
            ),
            "/trinsic.services.TrustRegistry/RegisterIssuer": grpclib.const.Handler(
                self.__rpc_register_issuer,
                grpclib.const.Cardinality.UNARY_UNARY,
                RegisterIssuerRequest,
                RegisterIssuerResponse,
            ),
            "/trinsic.services.TrustRegistry/RegisterVerifier": grpclib.const.Handler(
                self.__rpc_register_verifier,
                grpclib.const.Cardinality.UNARY_UNARY,
                RegisterVerifierRequest,
                RegisterVerifierResponse,
            ),
            "/trinsic.services.TrustRegistry/UnregisterMember": grpclib.const.Handler(
                self.__rpc_unregister_member,
                grpclib.const.Cardinality.UNARY_UNARY,
                UnregisterMemberRequest,
                UnregisterMemberResponse,
            ),
            "/trinsic.services.TrustRegistry/CheckIssuerStatus": grpclib.const.Handler(
                self.__rpc_check_issuer_status,
                grpclib.const.Cardinality.UNARY_UNARY,
                CheckIssuerStatusRequest,
                CheckIssuerStatusResponse,
            ),
            "/trinsic.services.TrustRegistry/CheckVerifierStatus": grpclib.const.Handler(
                self.__rpc_check_verifier_status,
                grpclib.const.Cardinality.UNARY_UNARY,
                CheckVerifierStatusRequest,
                CheckVerifierStatusResponse,
            ),
            "/trinsic.services.TrustRegistry/FetchData": grpclib.const.Handler(
