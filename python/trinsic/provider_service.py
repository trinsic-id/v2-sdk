...
# target: C:\work\sdk\python\trinsic\provider_service.py

    async def update_ecosystem(self, *, request: UpdateEcosystemRequest) -> UpdateEcosystemResponse:
        """  Update an existing ecosystem """
        
        return await self.client.update_ecosystem(request, metadata=self.build_metadata(request))
    
    async def grant_authorization(self, *, request: GrantAuthorizationRequest) -> GrantAuthorizationResponse:
        """  Grant user authorization to ecosystem resources """
        
        return await self.client.grant_authorization(request, metadata=self.build_metadata(request))
    
    async def revoke_authorization(self, *, request: RevokeAuthorizationRequest) -> RevokeAuthorizationResponse:
        """  Revoke user authorization to ecosystem resources """
        
        return await self.client.revoke_authorization(request, metadata=self.build_metadata(request))
    
    async def get_authorizations(self, *, request: GetAuthorizationsRequest) -> GetAuthorizationsResponse:
        """  Retrieve the list of permissions for this particular account/ecosystem """
        
        return await self.client.get_authorizations(request, metadata=self.build_metadata(request))
    
    async def add_webhook(self, *, request: AddWebhookRequest) -> AddWebhookResponse:
        """  Add a webhook endpoint to the ecosystem """
        
        return await self.client.add_webhook(request, metadata=self.build_metadata(request))
    
    async def delete_webhook(self, *, request: DeleteWebhookRequest) -> DeleteWebhookResponse:
        """  Delete a webhook endpoint from the ecosystem """
        
        return await self.client.delete_webhook(request, metadata=self.build_metadata(request))
    
    async def ecosystem_info(self, *, request: EcosystemInfoRequest) -> EcosystemInfoResponse:
        """  Get ecosystem information """
        
        return await self.client.ecosystem_info(request, metadata=self.build_metadata(request))
    
    async def get_public_ecosystem_info(self, *, request: GetPublicEcosystemInfoRequest) -> GetPublicEcosystemInfoResponse:
        """  Get public ecosystem information about *any* ecosystem """
        
        return await self.client.get_public_ecosystem_info(request, metadata=self.build_metadata())
    ...
    async def generate_token(self, *, request: GenerateTokenRequest) -> GenerateTokenResponse:
        ...
        return await self.client.generate_token(request, metadata=self.build_metadata(request))
    ...
    async def invitation_status(self, *, request: InvitationStatusRequest) -> InvitationStatusResponse:
        ...
        return await self.client.invitation_status(request, metadata=self.build_metadata(request))
    ...
    async def get_event_token(self, *, request: GetEventTokenRequest) -> GetEventTokenResponse:
        ...
        return await self.client.get_event_token(request, metadata=self.build_metadata(request))
    
    async def upgrade_did(self, *, request: UpgradeDidRequest) -> UpgradeDidResponse:
        """  Upgrade a wallet's DID from `did:key` to another method """
        
        return await self.client.upgrade_did(request, metadata=self.build_metadata(request))
    
    async def retrieve_domain_verification_record(self) -> RetrieveDomainVerificationRecordResponse:
        """  Retrieve a random hash TXT that can be used to verify domain ownership """
        request = RetrieveDomainVerificationRecordRequest()
        return await self.client.retrieve_domain_verification_record(request, metadata=self.build_metadata(request))
    
    async def refresh_domain_verification_status(self, *, request: RefreshDomainVerificationStatusRequest) -> RefreshDomainVerificationStatusResponse:
        """  Call to verify domain """
        
        return await self.client.refresh_domain_verification_status(request, metadata=self.build_metadata(request))
    
    async def search_wallet_configurations(self, *, request: SearchWalletConfigurationsRequest) -> SearchWalletConfigurationResponse:
        """  Search for issuers/providers/verifiers in the current ecosystem """
        
        return await self.client.search_wallet_configurations(request, metadata=self.build_metadata(request))
