...
"""
    ...
    async def retrieve_verification_record(self, *, request: RetrieveVerificationRecordRequest) -> Retrieveverificationrecordresponse:
        """
 Retrieve a random hash TXT that can be used to verify domain ownership

"""
        return await self.client.retrieve_verification_record(request, metadata=self.build_metadata(request))
    
    async def refresh_verification_status(self, *, request: RefreshVerificationStatusRequest) -> Refreshverificationstatusresponse:
        """
 Call to verif

"""
        return await self.client.refresh_verification_status(request, metadata=self.build_metadata(request))
