...
# target: D:\trinsic\sdk\python\trinsic\wallet_service.py
    ...
    async def delete_wallet(self, *, request: DeleteWalletRequest) -> DeleteWalletResponse:
        """  Delete a wallet and its credentials """
        
        return await self.client.delete_wallet(request, metadata=self.build_metadata(request))
