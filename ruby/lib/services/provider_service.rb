...
module Trinsic
  ...
  class ProviderService < ServiceBase
    ...
    # target: C:\work\sdk\ruby\lib\services\provider_service.rb
    nil
    ...
    # @param [RetrieveVerificationRecordRequest] request
    # @return [RetrieveVerificationRecordResponse]
    def retrieve_verification_record(request)
      @client.retrieve_verification_record(request, metadata: metadata(request))
    end

    #  Call to verif
    # @param [RefreshVerificationStatusRequest] request
    # @return [RefreshVerificationStatusResponse]
    def refresh_verification_status(request)
      @client.refresh_verification_status(request, metadata: metadata(request))
    end
