    ...
    module V1
      module TrustRegistry
        class Service
          ...
          rpc :AddFramework, ::Services::Trustregistry::V1::AddFrameworkRequest,
              ::Services::Trustregistry::V1::AddFrameworkResponse
          rpc :RemoveFramework, ::Services::Trustregistry::V1::RemoveFrameworkRequest,
              ::Services::Trustregistry::V1::RemoveFrameworkResponse
          rpc :SearchRegistry, ::Services::Trustregistry::V1::SearchRegistryRequest,
              ::Services::Trustregistry::V1::SearchRegistryResponse
          # Registers an authoritative issuer with a credential template
          rpc :RegisterMember, ::Services::Trustregistry::V1::RegisterMemberRequest,
          ...
          rpc :UnregisterMember, ::Services::Trustregistry::V1::UnregisterMemberRequest,
              ::Services::Trustregistry::V1::UnregisterMemberResponse
          rpc :GetMembershipStatus, ::Services::Trustregistry::V1::GetMembershipStatusRequest,
              ::Services::Trustregistry::V1::GetMembershipStatusResponse
          rpc :FetchData, ::Services::Trustregistry::V1::FetchDataRequest,
              stream(::Services::Trustregistry::V1::FetchDataResponse)
        end
