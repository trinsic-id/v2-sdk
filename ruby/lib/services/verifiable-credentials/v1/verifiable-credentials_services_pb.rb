    ...
    module V1
      module VerifiableCredential
        class Service
          ...
          rpc :Issue, ::Services::Verifiablecredentials::V1::IssueRequest,
              ::Services::Verifiablecredentials::V1::IssueResponse
          # Sign and issue a verifiable credential from a pre-defined template.
          # This process will also add schema validation and
          # revocation registry entry in the credential.
          rpc :IssueFromTemplate, ::Services::Verifiablecredentials::V1::IssueFromTemplateRequest,
              ::Services::Verifiablecredentials::V1::IssueFromTemplateResponse
          # Check credential status in the revocation registry
          rpc :CheckStatus, ::Services::Verifiablecredentials::V1::CheckStatusRequest,
              ::Services::Verifiablecredentials::V1::CheckStatusResponse
          # Update credential status by setting the revocation value
          rpc :UpdateStatus, ::Services::Verifiablecredentials::V1::UpdateStatusRequest,
          ...
          rpc :CreateProof, ::Services::Verifiablecredentials::V1::CreateProofRequest,
              ::Services::Verifiablecredentials::V1::CreateProofResponse
          # Verifies a proof by checking the signature value, and if possible schema validation,
          # revocation status, and issuer status against a trust registry
          rpc :VerifyProof, ::Services::Verifiablecredentials::V1::VerifyProofRequest,
              ::Services::Verifiablecredentials::V1::VerifyProofResponse
          # Sends a document directly to a user's email within the given ecosystem
          rpc :Send, ::Services::Verifiablecredentials::V1::SendRequest,
