...
* revocation registry values to the credential. */
  public async issueFromTemplate(request: IssueFromTemplateRequest): Promise<IssueFromTemplateResponse> {
  ...
  public async checkStatus(request: CheckStatusRequest): Promise<CheckStatusResponse> {
  ...
  public async updateStatus(request: UpdateStatusRequest): Promise<UpdateStatusResponse> {
...
* verifiable credential and contains a signature from which a proof can be derived. */
  public async createProof(request: CreateProofRequest): Promise<CreateProofResponse> {
...
* revocation status, and issuer status against a trust registry */
  public async verifyProof(request: VerifyProofRequest): Promise<VerifyProofResponse> {
