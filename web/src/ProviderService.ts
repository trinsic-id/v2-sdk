...
export class CreateEcosystemResponseWithProfile {
    response: CreateEcosystemResponse;
    base64Profile: string;

    constructor(response: CreateEcosystemResponse) {
        this.response = response;
        this.base64Profile = Base64.fromUint8Array(
...
export class ProviderService extends ServiceBase {
  ...
  public async createEcosystem(
  ...
  ): Promise<CreateEcosystemResponseWithProfile> {
    const response =
    ...
    const newResponse = new CreateEcosystemResponseWithProfile(response);
    this.options.authToken = newResponse.base64Profile;
    return newResponse;
  }
