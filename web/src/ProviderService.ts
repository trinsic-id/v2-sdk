...
// target: D:\trinsic\sdk\web\src\ProviderService.ts
...
*@deprecated This will be removed May 1, 2023 */
  ...
  public async refreshDomainVerificationStatus(request: proto.RefreshDomainVerificationStatusRequest): Promise<proto.RefreshDomainVerificationStatusResponse> {
