...
export class TrustRegistryService extends ServiceBase {
    ...
    public async getMemberAuthorizationStatus(
        request: proto.GetMemberAuthorizationStatusRequest,
    ): Promise<proto.GetMemberAuthorizationStatusResponse> {
        return this.client.getMemberAuthorizationStatus(request, {
            metadata: await this.buildMetadata(
                proto.GetMemberAuthorizationStatusRequest.encode(
                    request,
                ).finish(),
            ),
        });
    ...
    public async listAuthorizedMembers(
        request: proto.ListAuthorizedMembersRequest,
    ): Promise<proto.ListAuthorizedMembersResponse> {
        return this.client.listAuthorizedMembers(request, {
            metadata: await this.buildMetadata(
                proto.ListAuthorizedMembersRequest.encode(request).finish(),
            ),
        });
    }
    /** Get member for a given did in a trust registry */
    public async getMember(
        request: proto.GetMemberRequest,
    ): Promise<proto.GetMemberResponse> {
        return this.client.getMember(request, {
            metadata: await this.buildMetadata(
                proto.GetMemberRequest.encode(request).finish(),
            ),
        });
    }
