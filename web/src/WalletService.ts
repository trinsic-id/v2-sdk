...
export class WalletService extends ServiceBase {
    ...
    public async addExternalIdentityConfirm(
        ...
        return this.client.addExternalIdentityConfirm(request, {
            metadata: await this.buildMetadata(
                proto.AddExternalIdentityConfirmRequest.encode(
                    request,
                ).finish(),
            ),
        });
    ...
    public async authenticateResendCode(
        request: proto.AuthenticateResendCodeRequest,
    ): Promise<proto.AuthenticateResendCodeResponse> {
        return this.client.authenticateResendCode(request, {
            metadata: await this.buildMetadata(
                proto.AuthenticateResendCodeRequest.encode(request).finish(),
            ),
        });
    }
    ...
    public async listByVerificationTemplate(
        request: proto.ListByVerificationTemplateRequest,
    ): Promise<proto.ListByVerificationTemplateResponse> {
        return this.client.listByVerificationTemplate(request, {
            metadata: await this.buildMetadata(
                proto.ListByVerificationTemplateRequest.encode(
                    request,
                ).finish(),
            ),
        });
