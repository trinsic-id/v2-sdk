...
* This endpoint does not require authentication, and will return a challenge to be signed or verified */
  ...
  public async createDidWebDoc(request: proto.CreateDidWebDocRequest): Promise<proto.CreateDidWebDocResponse> {
    
    return this.client.createDidWebDoc(request, {
      metadata: await this.buildMetadata(proto.CreateDidWebDocRequest.encode(request).finish())
    });
  }
