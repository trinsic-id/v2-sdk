...
export const CreateSessionResponse2 = {
  encode(message: CreateSessionResponse2, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): CreateSessionResponse2 {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial(object: DeepPartial<CreateSessionResponse2>): CreateSessionResponse2 {
    const message = createBaseCreateSessionResponse2();
