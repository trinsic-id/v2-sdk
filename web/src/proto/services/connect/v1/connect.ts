...
export interface CreateSessionResponse2 {
...
export const IDVSession_VerificationsEntry = {
    ...
    create(
        base?: DeepPartial<IDVSession_VerificationsEntry>,
    ): IDVSession_VerificationsEntry {
        return IDVSession_VerificationsEntry.fromPartial(base ?? {});
    },
    fromPartial(
        object: DeepPartial<IDVSession_VerificationsEntry>,
    ): IDVSession_VerificationsEntry {
        const message = createBaseIDVSession_VerificationsEntry();
...
export const CreateSessionRequest = {
    ...
    fromPartial(
        object: DeepPartial<CreateSessionRequest>,
    ): CreateSessionRequest {
        const message = createBaseCreateSessionRequest();
...
export const RequestedVerification = {
    ...
    fromPartial(
        object: DeepPartial<RequestedVerification>,
    ): RequestedVerification {
        const message = createBaseRequestedVerification();
        message.type = object.type ?? 0;
        return message;
...
function createBaseCreateSessionResponse2(): CreateSessionResponse2 {
    return { session: undefined };
}

export const CreateSessionResponse2 = {
    encode(
        message: CreateSessionResponse2,
        writer: _m0.Writer = _m0.Writer.create(),
    ): _m0.Writer {
    ...
    decode(
        ...
        const reader =
            input instanceof _m0.Reader ? input : _m0.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = createBaseCreateSessionResponse2();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromJSON(object: any): CreateSessionResponse2 {
        return {
    ...
    toJSON(message: CreateSessionResponse2): unknown {
        const obj: any = {};
        if (message.session !== undefined) {
    ...
    create(base?: DeepPartial<CreateSessionResponse2>): CreateSessionResponse2 {
        return CreateSessionResponse2.fromPartial(base ?? {});
    },
    fromPartial(
        object: DeepPartial<CreateSessionResponse2>,
    ): CreateSessionResponse2 {
        const message = createBaseCreateSessionResponse2();
        message.session =
...
export const CancelSessionRequest = {
    ...
    fromPartial(
        object: DeepPartial<CancelSessionRequest>,
    ): CancelSessionRequest {
        const message = createBaseCancelSessionRequest();
...
export const CancelSessionResponse = {
    ...
    fromPartial(
        object: DeepPartial<CancelSessionResponse>,
    ): CancelSessionResponse {
        const message = createBaseCancelSessionResponse();
        message.session =
            object.session !== undefined && object.session !== null
...
export const ConnectDefinition = {
    ...
    methods: {
        ...
        createSession: {
            ...
            requestStream: false,
            responseType: CreateSessionResponse2,
