...
export const AnnotationOption = {
  encode(message: AnnotationOption, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
...
function createBaseSdkTemplateOption(): SdkTemplateOption {
  return { anonymous: false, ignore: false, noArguments: false, experimental: undefined, deprecated: undefined };
}

export const SdkTemplateOption = {
  encode(message: SdkTemplateOption, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.experimental !== undefined) {
      AnnotationOption.encode(message.experimental, writer.uint32(34).fork()).ldelim();
    }
    if (message.deprecated !== undefined) {
      AnnotationOption.encode(message.deprecated, writer.uint32(42).fork()).ldelim();
    }
    return writer;
  },
  ...
  fromJSON(object: any): SdkTemplateOption {
    return {
      ...
      noArguments: isSet(object.noArguments) ? Boolean(object.noArguments) : false,
      experimental: isSet(object.experimental) ? AnnotationOption.fromJSON(object.experimental) : undefined,
      deprecated: isSet(object.deprecated) ? AnnotationOption.fromJSON(object.deprecated) : undefined,
    };
  },
