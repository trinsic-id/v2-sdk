...
export interface ListAuthorizedMembersResponse {
    ...
    authorizedMembers?: AuthorizedMember[] | undefined;
...
export const RegisterMemberResponse = {
    ...
    fromPartial(
        _: DeepPartial<RegisterMemberResponse>,
    ): RegisterMemberResponse {
        const message = createBaseRegisterMemberResponse();
        return message;
    },
...
export const GetMemberAuthorizationStatusRequest = {
    ...
    create(
        base?: DeepPartial<GetMemberAuthorizationStatusRequest>,
    ): GetMemberAuthorizationStatusRequest {
        return GetMemberAuthorizationStatusRequest.fromPartial(base ?? {});
    },
    fromPartial(
        object: DeepPartial<GetMemberAuthorizationStatusRequest>,
    ): GetMemberAuthorizationStatusRequest {
        const message = createBaseGetMemberAuthorizationStatusRequest();
...
export const GetMemberAuthorizationStatusResponse = {
    ...
    create(
        base?: DeepPartial<GetMemberAuthorizationStatusResponse>,
    ): GetMemberAuthorizationStatusResponse {
        return GetMemberAuthorizationStatusResponse.fromPartial(base ?? {});
    },
    fromPartial(
        object: DeepPartial<GetMemberAuthorizationStatusResponse>,
    ): GetMemberAuthorizationStatusResponse {
        const message = createBaseGetMemberAuthorizationStatusResponse();
...
export const ListAuthorizedMembersRequest = {
    ...
    fromJSON(object: any): ListAuthorizedMembersRequest {
        return {
            schemaUri: isSet(object.schemaUri)
    ...
    create(
        base?: DeepPartial<ListAuthorizedMembersRequest>,
    ): ListAuthorizedMembersRequest {
        return ListAuthorizedMembersRequest.fromPartial(base ?? {});
    },
    fromPartial(
        object: DeepPartial<ListAuthorizedMembersRequest>,
    ): ListAuthorizedMembersRequest {
        const message = createBaseListAuthorizedMembersRequest();
...
export const ListAuthorizedMembersResponse = {
    encode(
        ...
        if (
            message.authorizedMembers !== undefined &&
            message.authorizedMembers.length !== 0
        ) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    message.authorizedMembers!.push(
                        AuthorizedMember.decode(reader, reader.uint32()),
                    );
                    continue;
                case 2:
                    if (tag !== 16) {
    ...
    fromJSON(object: any): ListAuthorizedMembersResponse {
        return {
            authorizedMembers: Array.isArray(object?.authorizedMembers)
                ? object.authorizedMembers.map((e: any) =>
                      AuthorizedMember.fromJSON(e),
                  )
                : [],
    ...
    toJSON(message: ListAuthorizedMembersResponse): unknown {
        ...
        if (message.authorizedMembers?.length) {
            obj.authorizedMembers = message.authorizedMembers.map((e) =>
                AuthorizedMember.toJSON(e),
            );
        }
        if (message.hasMoreResults === true) {
    ...
    create(
        base?: DeepPartial<ListAuthorizedMembersResponse>,
    ): ListAuthorizedMembersResponse {
        return ListAuthorizedMembersResponse.fromPartial(base ?? {});
    },
    fromPartial(
        object: DeepPartial<ListAuthorizedMembersResponse>,
    ): ListAuthorizedMembersResponse {
        const message = createBaseListAuthorizedMembersResponse();
        message.authorizedMembers =
            object.authorizedMembers?.map((e) =>
                AuthorizedMember.fromPartial(e),
            ) || [];
...
export const AuthorizedMember = {
    encode(
        ...
        if (
            message.authorizedMemberSchemas !== undefined &&
            message.authorizedMemberSchemas.length !== 0
        ) {
            for (const v of message.authorizedMemberSchemas) {
                AuthorizedMemberSchema.encode(
                    v!,
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    message.authorizedMemberSchemas!.push(
                        AuthorizedMemberSchema.decode(reader, reader.uint32()),
                    );
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
    ...
    fromJSON(object: any): AuthorizedMember {
        return {
            ...
            authorizedMemberSchemas: Array.isArray(
                object?.authorizedMemberSchemas,
            )
                ? object.authorizedMemberSchemas.map((e: any) =>
                      AuthorizedMemberSchema.fromJSON(e),
                  )
                : [],
        };
    },
    ...
    toJSON(message: AuthorizedMember): unknown {
        ...
        if (message.authorizedMemberSchemas?.length) {
            obj.authorizedMemberSchemas = message.authorizedMemberSchemas.map(
                (e) => AuthorizedMemberSchema.toJSON(e),
            );
        }
        return obj;
    },
    ...
    fromPartial(object: DeepPartial<AuthorizedMember>): AuthorizedMember {
        ...
        message.authorizedMemberSchemas =
            object.authorizedMemberSchemas?.map((e) =>
                AuthorizedMemberSchema.fromPartial(e),
            ) || [];
        return message;
    },
};
...
export const AuthorizedMemberSchema = {
    ...
    fromPartial(
        object: DeepPartial<AuthorizedMemberSchema>,
    ): AuthorizedMemberSchema {
        const message = createBaseAuthorizedMemberSchema();
        message.schemaUri = object.schemaUri ?? "";
...
export const GetMemberResponse = {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    message.authorizedMember = AuthorizedMember.decode(
                        reader,
                        reader.uint32(),
                    );
                    continue;
    ...
    fromJSON(object: any): GetMemberResponse {
        return {
            authorizedMember: isSet(object.authorizedMember)
                ? AuthorizedMember.fromJSON(object.authorizedMember)
                : undefined,
        };
    },
    ...
    toJSON(message: GetMemberResponse): unknown {
        const obj: any = {};
        if (message.authorizedMember !== undefined) {
            obj.authorizedMember = AuthorizedMember.toJSON(
                message.authorizedMember,
            );
        }
        return obj;
    ...
    fromPartial(object: DeepPartial<GetMemberResponse>): GetMemberResponse {
        const message = createBaseGetMemberResponse();
        message.authorizedMember =
            object.authorizedMember !== undefined &&
            object.authorizedMember !== null
