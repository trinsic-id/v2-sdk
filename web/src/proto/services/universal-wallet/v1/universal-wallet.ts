...
export const CreateWalletRequest = {
    encode(
        ...
        if (message.identity !== undefined) {
            CreateWalletRequest_ExternalIdentity.encode(
                message.identity,
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    ...
                    message.identity =
                        CreateWalletRequest_ExternalIdentity.decode(
                            reader,
                            reader.uint32(),
                        );
                    continue;
    ...
    fromJSON(object: any): CreateWalletRequest {
        return {
            ...
            identity: isSet(object.identity)
                ? CreateWalletRequest_ExternalIdentity.fromJSON(object.identity)
                : undefined,
        };
    },
    ...
    toJSON(message: CreateWalletRequest): unknown {
        ...
        if (message.identity !== undefined) {
            obj.identity = CreateWalletRequest_ExternalIdentity.toJSON(
                message.identity,
            );
        }
        return obj;
    ...
    fromPartial(object: DeepPartial<CreateWalletRequest>): CreateWalletRequest {
        ...
        message.identity =
            object.identity !== undefined && object.identity !== null
                ? CreateWalletRequest_ExternalIdentity.fromPartial(
                      object.identity,
                  )
                : undefined;
        return message;
...
export const CreateWalletRequest_ExternalIdentity = {
    encode(
        message: CreateWalletRequest_ExternalIdentity,
        writer: _m0.Writer = _m0.Writer.create(),
    ): _m0.Writer {
    ...
    create(
        base?: DeepPartial<CreateWalletRequest_ExternalIdentity>,
    ): CreateWalletRequest_ExternalIdentity {
        return CreateWalletRequest_ExternalIdentity.fromPartial(base ?? {});
    },
    fromPartial(
        object: DeepPartial<CreateWalletRequest_ExternalIdentity>,
    ): CreateWalletRequest_ExternalIdentity {
        const message = createBaseCreateWalletRequest_ExternalIdentity();
...
export const CreateWalletResponse = {
    ...
    fromPartial(
        object: DeepPartial<CreateWalletResponse>,
    ): CreateWalletResponse {
        const message = createBaseCreateWalletResponse();
...
export const GetWalletInfoRequest = {
    ...
    fromPartial(
        object: DeepPartial<GetWalletInfoRequest>,
    ): GetWalletInfoRequest {
        const message = createBaseGetWalletInfoRequest();
        message.walletId = object.walletId ?? "";
        return message;
...
export const AuthenticateResendCodeRequest = {
    ...
    create(
        base?: DeepPartial<AuthenticateResendCodeRequest>,
    ): AuthenticateResendCodeRequest {
        return AuthenticateResendCodeRequest.fromPartial(base ?? {});
    },
    fromPartial(
        object: DeepPartial<AuthenticateResendCodeRequest>,
    ): AuthenticateResendCodeRequest {
        const message = createBaseAuthenticateResendCodeRequest();
        message.challenge = object.challenge ?? "";
        return message;
...
export const AuthenticateResendCodeResponse = {
    encode(
        _: AuthenticateResendCodeResponse,
        writer: _m0.Writer = _m0.Writer.create(),
    ): _m0.Writer {
        return writer;
    },
    ...
    create(
        base?: DeepPartial<AuthenticateResendCodeResponse>,
    ): AuthenticateResendCodeResponse {
        return AuthenticateResendCodeResponse.fromPartial(base ?? {});
    },
    fromPartial(
        _: DeepPartial<AuthenticateResendCodeResponse>,
    ): AuthenticateResendCodeResponse {
        const message = createBaseAuthenticateResendCodeResponse();
        return message;
    },
...
export const ListByVerificationTemplateRequest = {
    ...
    create(
        base?: DeepPartial<ListByVerificationTemplateRequest>,
    ): ListByVerificationTemplateRequest {
        return ListByVerificationTemplateRequest.fromPartial(base ?? {});
    },
    fromPartial(
        object: DeepPartial<ListByVerificationTemplateRequest>,
    ): ListByVerificationTemplateRequest {
        const message = createBaseListByVerificationTemplateRequest();
...
export const ListByVerificationTemplateResponse = {
    ...
    create(
        base?: DeepPartial<ListByVerificationTemplateResponse>,
    ): ListByVerificationTemplateResponse {
        return ListByVerificationTemplateResponse.fromPartial(base ?? {});
    },
    fromPartial(
        object: DeepPartial<ListByVerificationTemplateResponse>,
    ): ListByVerificationTemplateResponse {
        const message = createBaseListByVerificationTemplateResponse();
        message.items = object.items?.map((e) => e) || [];
        message.hasMoreResults = object.hasMoreResults ?? false;
